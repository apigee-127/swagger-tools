...
"use strict";var _=require("lodash"),async=require("async"),helpers=require("./helpers"),JsonRefs=require("json-refs"),SparkMD5=require("spark-md5"),traverse=require("traverse"),validators=require("./validators"),documentCache={},addExternalRefsToValidator=function e(r,n,i){var t=_.reduce(JsonRefs.findRefs(n),function(e,r,n){return JsonRefs.isRemotePointer(n)&&e.push(r.split("#")[0]),e},[]),s=function(n,i){JsonRefs.resolveRefs({$ref:n},function(n,t){return n?i(n):void e(r,t,function(e,r){i(e,r)})})};t.length>0?async.map(t,s,function(e,n){return e?i(e):(_.each(n,function(e,n){r.setRemoteReference(t[n],e)}),void i())}):i()},createErrorOrWarning=function(e,r,n,i){i.push({code:e,message:r,path:n})},addReference=function(e,r,n,i,t){var s=!0,o=helpers.getSwaggerVersion(e.resolved),a=_.isArray(r)?r:JsonRefs.pathFromPointer(r),c=_.isArray(r)?JsonRefs.pathToPointer(r):r,d=_.isArray(n)?n:JsonRefs.pathFromPointer(n),u=_.isArray(n)?JsonRefs.pathToPointer(n):n,f=e.definitions[c],h=a[0],p="securityDefinitions"===h?"SECURITY_DEFINITION":h.substring(0,h.length-1).toUpperCase(),l="1.2"===o?a[a.length-1]:c,g="securityDefinitions"===h?"Security definition":p.charAt(0)+p.substring(1).toLowerCase();return["authorizations","securityDefinitions"].indexOf(a[0])>-1&&"scopes"===a[2]&&(p+="_SCOPE",g+=" scope"),_.isUndefined(f)?(t||createErrorOrWarning("UNRESOLVABLE_"+p,g+" could not be resolved: "+l,d,i.errors),s=!1):(_.isUndefined(f.references)&&(f.references=[]),f.references.push(u)),s},getOrComposeSchema=function r(e,n){var i,t,s="Composed "+("1.2"===e.swaggerVersion?JsonRefs.pathFromPointer(n).pop():n),o=e.definitions[n],a=traverse(e.original),c=traverse(e.resolved);return o?(t=_.cloneDeep(a.get(JsonRefs.pathFromPointer(n))),i=_.cloneDeep(c.get(JsonRefs.pathFromPointer(n))),"1.2"===e.swaggerVersion&&(o.lineage.length>0&&(i.allOf=[],_.each(o.lineage,function(n){i.allOf.push(r(e,n))})),delete i.subTypes,_.each(i.properties,function(n,i){var s=t.properties[i];_.each(["maximum","minimum"],function(e){_.isString(n[e])&&(n[e]=parseFloat(n[e]))}),_.each(JsonRefs.findRefs(s),function(i,t){var s="#/models/"+i,o=e.definitions[s],a=JsonRefs.pathFromPointer(t);o.lineage.length>0?traverse(n).set(a.slice(0,a.length-1),r(e,s)):(traverse(n).set(a.slice(0,a.length-1).concat("title"),"Composed "+i),traverse(n).set(a.slice(0,a.length-1).concat("type"),"object"))})})),i=traverse(i).map(function(e){"id"===this.key&&_.isString(e)&&this.remove()}),i.title=s,i.type="object",i):void 0},createUnusedErrorOrWarning=function(e,r,n,i,t){createErrorOrWarning("UNUSED_"+r,n+" is defined but is not used: "+e,i,t)},formatResults=function(e){return e?e.errors.length+e.warnings.length+_.reduce(e.apiDeclarations,function(e,r){return r&&(e+=r.errors.length+r.warnings.length),e},0)>0?e:void 0:e},getDocumentCache=function(e){var r=SparkMD5.hash(JSON.stringify(e)),n=documentCache[r]||_.find(documentCache,function(e){return e.resolvedId===r});return n||(n=documentCache[r]={definitions:{},original:e,resolved:void 0,swaggerVersion:helpers.getSwaggerVersion(e)}),n},handleValidationError=function(e,r){var n=new Error("The Swagger document is invalid and model composition is not possible");n.errors=e.errors,n.warnings=e.warnings,r(n)},normalizePath=function(e){var r=e.match(/\{(.*?)\}/g),n=[],i=e;return r&&_.each(r,function(e,r){i=i.replace(e,"{"+r+"}"),n.push(e.replace(/[{}]/g,""))}),{path:i,args:n}},validateNoExist=function(e,r,n,i,t,s){!_.isUndefined(e)&&e.indexOf(r)>-1&&createErrorOrWarning("DUPLICATE_"+n,i+" already defined: "+r,t,s)},validateSchemaConstraints=function(e,r,n,i,t){try{validators.validateSchemaConstraints(e.swaggerVersion,r,n,void 0)}catch(s){t||createErrorOrWarning(s.code,s.message,s.path,i.errors)}},processDocument=function(e,r){var n=e.swaggerVersion,i=function(r){var n=JsonRefs.pathToPointer(r),i=e.definitions[n];return i||(i=e.definitions[n]={references:[]},["definitions","models"].indexOf(JsonRefs.pathFromPointer(n)[0])>-1&&(i.cyclical=!1,i.lineage=void 0,i.parents=[])),i},t=function(e){return"1.2"===n?JsonRefs.pathFromPointer(e).pop():e},s=function c(r,n,i){var t=e.definitions[n||r];t&&_.each(t.parents,function(e){i.push(e),r!==e&&c(r,e,i)})},o="1.2"===n?"authorizations":"securityDefinitions",a="1.2"===n?"models":"definitions";switch(_.each(e.resolved[o],function(e,t){var s=[o,t];("1.2"!==n||e.type)&&(i(s),_.reduce(e.scopes,function(e,t,o){var a="1.2"===n?t.scope:o,c=s.concat(["scopes",o.toString()]),d=i(s.concat(["scopes",a]));return d.scopePath=c,validateNoExist(e,a,"AUTHORIZATION_SCOPE_DEFINITION","Authorization scope definition","1.2"===n?c.concat("scope"):c,r.warnings),e.push(a),e},[]))}),_.each(e.resolved[a],function(t,s){var o=[a,s],c=i(o);if("1.2"===n&&s!==t.id&&createErrorOrWarning("MODEL_ID_MISMATCH","Model id does not match id in models object: "+t.id,o.concat("id"),r.errors),_.isUndefined(c.lineage))switch(n){case"1.2":_.each(t.subTypes,function(n,t){var s=["models",n],c=JsonRefs.pathToPointer(s),d=e.definitions[c],u=o.concat(["subTypes",t.toString()]);!d&&e.resolved[a][n]&&(d=i(s)),addReference(e,s,u,r)&&d.parents.push(JsonRefs.pathToPointer(o))});break;default:_.each(e.original[a][s].allOf,function(n,t){var s,a,d=o.concat(["allOf",t.toString()]);_.isUndefined(n.$ref)||JsonRefs.isRemotePointer(n.$ref)?a=o.concat(["allOf",t.toString()]):(s=i(JsonRefs.pathFromPointer(n.$ref)),a=JsonRefs.pathFromPointer(n.$ref)),c.parents.push(JsonRefs.pathToPointer(a)),s&&addReference(e,a,d,r)})}}),n){case"2.0":_.each(e.resolved.parameters,function(n,t){var s=["parameters",t];i(s),validateSchemaConstraints(e,n,s,r)}),_.each(e.resolved.responses,function(n,t){var s=["responses",t];i(s),validateSchemaConstraints(e,n,s,r)})}_.each(e.definitions,function(i,o){var a,c,d,u=JsonRefs.pathFromPointer(o),f=traverse(e.original).get(u),h=u[0],p=h.substring(0,h.length-1).toUpperCase(),l=p.charAt(0)+p.substring(1).toLowerCase();-1!==["definitions","models"].indexOf(h)&&(a=[],c=[],d=i.lineage,_.isUndefined(d)&&(d=[],s(o,void 0,d),d.reverse(),i.lineage=_.cloneDeep(d),i.cyclical=d.length>1&&d[0]===o),i.parents.length>1&&"1.2"===n&&createErrorOrWarning("MULTIPLE_"+p+"_INHERITANCE","Child "+p.toLowerCase()+" is sub type of multiple models: "+_.map(i.parents,function(e){return t(e)}).join(" && "),u,r.errors),i.cyclical&&createErrorOrWarning("CYCLICAL_"+p+"_INHERITANCE",l+" has a circular inheritance: "+_.map(d,function(e){return t(e)}).join(" -> ")+" -> "+t(o),u.concat("1.2"===n?"subTypes":"allOf"),r.errors),_.each(d.slice(i.cyclical?1:0),function(r){var n=traverse(e.resolved).get(JsonRefs.pathFromPointer(r));_.each(Object.keys(n.properties),function(e){-1===c.indexOf(e)&&c.push(e)})}),validateSchemaConstraints(e,f,u,r),_.each(f.properties,function(n,i){var t=u.concat(["properties",i]);_.isUndefined(n)||(validateSchemaConstraints(e,n,t,r),c.indexOf(i)>-1?createErrorOrWarning("CHILD_"+p+"_REDECLARES_PROPERTY","Child "+p.toLowerCase()+" declares property already declared by ancestor: "+i,t,r.errors):a.push(i))}),_.each(f.required||[],function(e,n){-1===c.indexOf(e)&&-1===a.indexOf(e)&&createErrorOrWarning("MISSING_REQUIRED_MODEL_PROPERTY","Model requires property but it is not defined: "+e,u.concat(["required",n.toString()]),r.errors)}))}),_.each(JsonRefs.findRefs(e.original),function(n,i){"1.2"===e.swaggerVersion&&(n="#/models/"+n),JsonRefs.isRemotePointer(n)||addReference(e,n,i,r)})},validateExist=function(e,r,n,i,t,s){_.isUndefined(e)||-1!==e.indexOf(r)||createErrorOrWarning("UNRESOLVABLE_"+n,i+" could not be resolved: "+r,t,s)},processAuthRefs=function(e,r,n,i){var t="1.2"===e.swaggerVersion?"AUTHORIZATION":"SECURITY_DEFINITION",s="AUTHORIZATION"===t?"Authorization":"Security definition";"1.2"===e.swaggerVersion?_.reduce(r,function(r,o,a){var c="#/authorizations/"+a,d=n.concat([a]);return addReference(e,c,d,i)&&_.reduce(o,function(r,n,o){var a=d.concat(o.toString(),"scope"),u=c+"/scopes/"+n.scope;return validateNoExist(r,n.scope,t+"_SCOPE_REFERENCE",s+" scope reference",a,i.warnings),addReference(e,u,a,i),r.concat(n.scope)},[]),r.concat(a)},[]):_.reduce(r,function(r,o,a){return _.each(o,function(o,c){var d="#/securityDefinitions/"+c,u=n.concat(a.toString(),c);validateNoExist(r,c,t+"_REFERENCE",s+" reference",u,i.warnings),r.push(c),addReference(e,d,u,i)&&_.each(o,function(r,n){addReference(e,d+"/scopes/"+r,u.concat(n.toString()),i)})}),r},[])},resolveRefs=function(e,r){var n,i=getDocumentCache(e),t=helpers.getSwaggerVersion(e);i.resolved?r():("1.2"===t&&(e=_.cloneDeep(e),n=traverse(e),_.each(JsonRefs.findRefs(e),function(e,r){n.set(JsonRefs.pathFromPointer(r),"#/models/"+e)})),JsonRefs.resolveRefs(e,function(e,n){return e?r(e):(i.resolved=n,i.resolvedId=SparkMD5.hash(JSON.stringify(n)),void r())}))},validateAgainstSchema=function(e,r,n,i){var t=_.isString(r)?e.validators[r]:helpers.createJsonValidator(),s=function(){try{validators.validateAgainstSchema(r,n,t)}catch(e){return e.failedValidation?i(void 0,e.results):i(e)}resolveRefs(n,function(e){return i(e)})};addExternalRefsToValidator(t,n,function(e){return e?i(e):void s()})},validateDefinitions=function(e,r){_.each(e.definitions,function(n,i){var t=JsonRefs.pathFromPointer(i),s=t[0].substring(0,t[0].length-1),o="1.2"===e.swaggerVersion?t[t.length-1]:i,a="securityDefinition"===s?"SECURITY_DEFINITION":s.toUpperCase(),c="securityDefinition"===s?"Security definition":s.charAt(0).toUpperCase()+s.substring(1);0===n.references.length&&(n.scopePath&&(a+="_SCOPE",c+=" scope",t=n.scopePath),createUnusedErrorOrWarning(o,a,c,t,r.warnings))})},validateParameters=function(e,r,n,i,t,s,o){var a=[];_.reduce(i,function(e,i,o){var c=t.concat(["parameters",o.toString()]);if(!_.isUndefined(i))return validateNoExist(e,i.name,"PARAMETER","Parameter",c.concat("name"),s.errors),("path"===i.paramType||"path"===i.in)&&(-1===n.args.indexOf(i.name)&&createErrorOrWarning("UNRESOLVABLE_API_PATH_PARAMETER","API path parameter could not be resolved: "+i.name,c.concat("name"),s.errors),a.push(i.name)),validateSchemaConstraints(r,i,c,s,i.skipErrors),e.concat(i.name)},[]),(_.isUndefined(o)||o===!1)&&_.each(_.difference(n.args,a),function(e){createErrorOrWarning("MISSING_API_PATH_PARAMETER","API requires path parameter but it is not defined: "+e,"1.2"===r.swaggerVersion?t.slice(0,2).concat("path"):t,s.errors)})},validateSwagger1_2=function(e,r,n,i){var t=[],s=getDocumentCache(r),o=[],a={errors:[],warnings:[],apiDeclarations:[]};o=_.reduce(r.apis,function(e,r,n){return validateNoExist(e,r.path,"RESOURCE_PATH","Resource path",["apis",n.toString(),"path"],a.errors),e.push(r.path),e},[]),processDocument(s,a),t=_.reduce(n,function(r,n,i){var c=a.apiDeclarations[i]={errors:[],warnings:[]},d=getDocumentCache(n);return validateNoExist(r,n.resourcePath,"RESOURCE_PATH","Resource path",["resourcePath"],c.errors),-1===t.indexOf(n.resourcePath)&&(validateExist(o,n.resourcePath,"RESOURCE_PATH","Resource path",["resourcePath"],c.errors),r.push(n.resourcePath)),processDocument(d,c),_.reduce(n.apis,function(r,n,i){var t=["apis",i.toString()],o=normalizePath(n.path);return r.indexOf(o.path)>-1?createErrorOrWarning("DUPLICATE_API_PATH","API path (or equivalent) already defined: "+n.path,t.concat("path"),c.errors):r.push(o.path),_.reduce(n.operations,function(r,n,i){var a=t.concat(["operations",i.toString()]);return validateNoExist(r,n.method,"OPERATION_METHOD","Operation method",a.concat("method"),c.errors),r.push(n.method),-1===e.primitives.indexOf(n.type)&&"1.2"===e.version&&addReference(d,"#/models/"+n.type,a.concat("type"),c),processAuthRefs(s,n.authorizations,a.concat("authorizations"),c),validateSchemaConstraints(d,n,a,c),validateParameters(e,d,o,n.parameters,a,c),_.reduce(n.responseMessages,function(e,r,n){var i=a.concat(["responseMessages",n.toString()]);return validateNoExist(e,r.code,"RESPONSE_MESSAGE_CODE","Response message code",i.concat(["code"]),c.errors),r.responseModel&&addReference(d,"#/models/"+r.responseModel,i.concat("responseModel"),c),e.concat(r.code)},[]),r},[]),r},[]),validateDefinitions(d,c),r},[]),validateDefinitions(s,a),_.each(_.difference(o,t),function(e){var n=o.indexOf(e);createUnusedErrorOrWarning(r.apis[n].path,"RESOURCE_PATH","Resource path",["apis",n.toString(),"path"],a.errors)}),i(void 0,a)},validateSwagger2_0=function(e,r,n){var i=getDocumentCache(r),t={errors:[],warnings:[]};processDocument(i,t),processAuthRefs(i,r.security,["security"],t),_.reduce(i.resolved.paths,function(r,n,s){var o=["paths",s],a=normalizePath(s);return r.indexOf(a.path)>-1&&createErrorOrWarning("DUPLICATE_API_PATH","API path (or equivalent) already defined: "+s,o,t.errors),validateParameters(e,i,a,n.parameters,o,t,!0),_.each(n,function(r,s){var c=[],d=o.concat(s),u=[];"parameters"!==s&&(processAuthRefs(i,r.security,d.concat("security"),t),_.each(r.parameters,function(e){c.push(e),u.push(e.name+":"+e.in)}),_.each(n.parameters,function(e){var r=_.cloneDeep(e);r.skipErrors=!0,-1===u.indexOf(e.name+":"+e.in)&&c.push(r)}),validateParameters(e,i,a,c,d,t),_.each(r.responses,function(e,r){validateSchemaConstraints(i,e,d.concat("responses",r),t)}))}),r.concat(a.path)},[]),validateDefinitions(i,t),n(void 0,t)},validateSemantically=function(e,r,n,i){var t=function(e,r){i(e,formatResults(r))};"1.2"===e.version?validateSwagger1_2(e,r,n,t):validateSwagger2_0(e,r,t)},validateStructurally=function(e,r,n,i){validateAgainstSchema(e,"1.2"===e.version?"resourceListing.json":"schema.json",r,function(r,t){return r?i(r):void(t||"1.2"!==e.version?i(void 0,t):(t={errors:[],warnings:[],apiDeclarations:[]},async.map(n,function(r,n){validateAgainstSchema(e,"apiDeclaration.json",r,n)},function(e,r){return e?i(e):(_.each(r,function(e,r){t.apiDeclarations[r]=e}),void i(void 0,t))})))})},Specification=function(e){var r=function(e,r){return _.reduce(r,function(e,r,n){return e[n]=helpers.createJsonValidator(r),e}.bind(this),{})},n=function(e){var r=_.cloneDeep(this.schemas[e]);return r.id=e,r}.bind(this),i=["string","number","boolean","integer","array"];switch(e){case"1.2":this.docsUrl="https://github.com/swagger-api/swagger-spec/blob/master/versions/1.2.md",this.primitives=_.union(i,["void","File"]),this.schemasUrl="https://github.com/swagger-api/swagger-spec/tree/master/schemas/v1.2",this.schemas={"apiDeclaration.json":require("../schemas/1.2/apiDeclaration.json"),"authorizationObject.json":require("../schemas/1.2/authorizationObject.json"),"dataType.json":require("../schemas/1.2/dataType.json"),"dataTypeBase.json":require("../schemas/1.2/dataTypeBase.json"),"infoObject.json":require("../schemas/1.2/infoObject.json"),"modelsObject.json":require("../schemas/1.2/modelsObject.json"),"oauth2GrantType.json":require("../schemas/1.2/oauth2GrantType.json"),"operationObject.json":require("../schemas/1.2/operationObject.json"),"parameterObject.json":require("../schemas/1.2/parameterObject.json"),"resourceListing.json":require("../schemas/1.2/resourceListing.json"),"resourceObject.json":require("../schemas/1.2/resourceObject.json")},this.validators=r(this,{"apiDeclaration.json":_.map(["dataTypeBase.json","modelsObject.json","oauth2GrantType.json","authorizationObject.json","parameterObject.json","operationObject.json","apiDeclaration.json"],n),"resourceListing.json":_.map(["resourceObject.json","infoObject.json","oauth2GrantType.json","authorizationObject.json","resourceListing.json"],n)});break;case"2.0":this.docsUrl="https://github.com/swagger-api/swagger-spec/blob/master/versions/2.0.md",this.primitives=_.union(i,["file"]),this.schemasUrl="https://github.com/swagger-api/swagger-spec/tree/master/schemas/v2.0",this.schemas={"schema.json":require("../schemas/2.0/schema.json")},this.validators=r(this,{"schema.json":[n("schema.json")]});break;default:throw new Error(e+" is an unsupported Swagger specification version")}this.version=e};Specification.prototype.validate=function(e,r,n){switch(this.version){case"1.2":if(_.isUndefined(e))throw new Error("resourceListing is required");if(!_.isPlainObject(e))throw new TypeError("resourceListing must be an object");if(_.isUndefined(r))throw new Error("apiDeclarations is required");if(!_.isArray(r))throw new TypeError("apiDeclarations must be an array");break;case"2.0":if(_.isUndefined(e))throw new Error("swaggerObject is required");if(!_.isPlainObject(e))throw new TypeError("swaggerObject must be an object")}if("2.0"===this.version&&(n=arguments[1]),_.isUndefined(n))throw new Error("callback is required");if(!_.isFunction(n))throw new TypeError("callback must be a function");"2.0"===this.version&&(r=[]),validateStructurally(this,e,r,function(i,t){i||formatResults(t)?n(i,t):validateSemantically(this,e,r,n)}.bind(this))},Specification.prototype.composeSchema=function(e,r,n){var i=helpers.getSwaggerVersion(e),t=function(i,t){var s;return i?n(i):formatResults(t)?handleValidationError(t,n):(s=getDocumentCache(e),t={errors:[],warnings:[]},processDocument(s,t),s.definitions[r]?formatResults(t)?handleValidationError(t,n):void n(void 0,getOrComposeSchema(s,r)):n())};switch(this.version){case"1.2":if(_.isUndefined(e))throw new Error("apiDeclaration is required");if(!_.isPlainObject(e))throw new TypeError("apiDeclaration must be an object");if(_.isUndefined(r))throw new Error("modelId is required");break;case"2.0":if(_.isUndefined(e))throw new Error("swaggerObject is required");if(!_.isPlainObject(e))throw new TypeError("swaggerObject must be an object");if(_.isUndefined(r))throw new Error("modelRef is required")}if(_.isUndefined(n))throw new Error("callback is required");if(!_.isFunction(n))throw new TypeError("callback must be a function");if("#"!==r.charAt(0)){if("1.2"!==this.version)throw new Error("modelRef must be a JSON Pointer");r="#/models/"+r}validateAgainstSchema(this,"1.2"===i?"apiDeclaration.json":"schema.json",e,t)},Specification.prototype.validateModel=function(e,r,n,i){switch(this.version){case"1.2":if(_.isUndefined(e))throw new Error("apiDeclaration is required");if(!_.isPlainObject(e))throw new TypeError("apiDeclaration must be an object");if(_.isUndefined(r))throw new Error("modelId is required");break;case"2.0":if(_.isUndefined(e))throw new Error("swaggerObject is required");if(!_.isPlainObject(e))throw new TypeError("swaggerObject must be an object");if(_.isUndefined(r))throw new Error("modelRef is required")}if(_.isUndefined(n))throw new Error("data is required");if(_.isUndefined(i))throw new Error("callback is required");if(!_.isFunction(i))throw new TypeError("callback must be a function");this.composeSchema(e,r,function(e,r){return e?i(e):void validateAgainstSchema(this,r,n,i)}.bind(this))},Specification.prototype.resolve=function(e,r,n){var i,t,s=function(e){return _.isString(r)?n(void 0,traverse(e).get(JsonRefs.pathFromPointer(r))):n(void 0,e)};if(_.isUndefined(e))throw new Error("document is required");if(!_.isPlainObject(e))throw new TypeError("document must be an object");if(2===arguments.length&&(n=arguments[1],r=void 0),!_.isUndefined(r)&&!_.isString(r))throw new TypeError("ptr must be a JSON Pointer string");if(_.isUndefined(n))throw new Error("callback is required");if(!_.isFunction(n))throw new TypeError("callback must be a function");if(i=getDocumentCache(e),"1.2"===i.swaggerVersion)throw new Error("Swagger 1.2 is not supported");return i.resolved?s(i.resolved):(t="1.2"===i.swaggerVersion?_.find(["basePath","consumes","models","produces","resourcePath"],function(r){return!_.isUndefined(e[r])})?"apiDeclaration.json":"resourceListing.json":"schema.json",void validateAgainstSchema(this,t,e,function(e,r){return e?n(e):formatResults(r)?handleValidationError(r,n):s(i.resolved)}))},module.exports.v1=module.exports.v1_2=new Specification("1.2"),module.exports.v2=module.exports.v2_0=new Specification("2.0");
},{"../schemas/1.2/apiDeclaration.json":23,"../schemas/1.2/authorizationObject.json":24,"../schemas/1.2/dataType.json":25,"../schemas/1.2/dataTypeBase.json":26,"../schemas/1.2/infoObject.json":27,"../schemas/1.2/modelsObject.json":28,"../schemas/1.2/oauth2GrantType.json":29,"../schemas/1.2/operationObject.json":30,"../schemas/1.2/parameterObject.json":31,"../schemas/1.2/resourceListing.json":32,"../schemas/1.2/resourceObject.json":33,"../schemas/2.0/schema.json":34,"./helpers":2,"./validators":3,"async":4,"json-refs":6,"lodash":10,"spark-md5":11,"traverse":12}],2:[function(require,module,exports){
(function(r){"use strict";var e=require("lodash"),n=require("json-refs"),o=require("z-schema"),t=require("../schemas/json-schema-draft-04.json"),a="http://json-schema.org/draft-04/schema",i={};module.exports.createJsonValidator=function(r){var i,s=new o({reportPathAsArray:!0});if(s.setRemoteReference(a,t),e.each(["byte","double","float","int32","int64","mime-type","uri-template"],function(r){o.registerFormat(r,function(){return!0})}),!e.isUndefined(r)&&(i=s.compileSchema(r),i===!1))throw console.error("JSON Schema file"+(r.length>1?"s are":" is")+" invalid:"),e.each(s.getLastErrors(),function(r){console.error("  "+(e.isArray(r.path)?n.pathToPointer(r.path):r.path)+": "+r.message)}),new Error("Unable to create validator due to invalid JSON Schema");return s},module.exports.getSpec=function(r){var n=i[r];if(e.isUndefined(n))switch(r){case"1.2":n=require("../lib/specs").v1_2;break;case"2.0":n=require("../lib/specs").v2_0}return n},module.exports.getSwaggerVersion=function(r){return e.isPlainObject(r)?r.swaggerVersion||r.swagger:void 0};var s=module.exports.toJsonPointer=function(r){return"#/"+r.map(function(r){return r.replace(/~/g,"~0").replace(/\//g,"~1")}).join("/")};module.exports.printValidationResults=function(n,o,t,a,i,c){var l=function(r,e){return 1===e?r:r+"s"},u=function f(r,n,o){console.error(r),console.error(),e.each(n,function(e){console.error(new Array(o+1).join(" ")+s(e.path)+": "+e.message),e.inner&&f(r,e.inner,o+2)}),console.error()},g=0,h=0;console.error(),a.errors.length>0&&(g+=a.errors.length,u("API Errors:",a.errors,2)),a.warnings.length>0&&(h+=a.warnings.length,u("API Warnings:",a.warnings,2)),a.apiDeclarations&&a.apiDeclarations.forEach(function(r,e){if(r){var n=t[e].resourcePath||e;r.errors.length>0&&(g+=r.errors.length,u("  API Declaration ("+n+") Errors:",r.errors,4)),r.warnings.length>0&&(h+=r.warnings.length,u("  API Declaration ("+n+") Warnings:",r.warnings,4))}}),i&&console.error(g>0?g+" "+l("error",g)+" and "+h+" "+l("warning",h):"Validation succeeded but with "+h+" "+l("warning",h)),g>0&&c&&r.exit(1)}}).call(this,require("_process"));
},{"../lib/specs":undefined,"../schemas/json-schema-draft-04.json":35,"_process":5,"json-refs":6,"lodash":10,"z-schema":22}],3:[function(require,module,exports){
"use strict";var _=require("lodash"),helpers=require("./helpers"),dateRegExp=/^([0-9]{4})-([0-9]{2})-([0-9]{2})$/,dateTimeRegExp=/^([0-9]{2}):([0-9]{2}):([0-9]{2})(.[0-9]+)?(z|([+-][0-9]{2}:[0-9]{2}))$/,isValidDate=function(e){var t,i,a;return _.isString(e)||(e=e.toString()),i=dateRegExp.exec(e),null===i?!1:(t=i[3],a=i[2],"01">a||a>"12"||"01">t||t>"31"?!1:!0)},isValidDateTime=function(e){var t,i,a,r,n,o,d;return _.isString(e)||(e=e.toString()),o=e.toLowerCase().split("t"),i=o[0],a=o.length>1?o[1]:void 0,isValidDate(i)?(r=dateTimeRegExp.exec(a),null===r?!1:(t=r[1],n=r[2],d=r[3],t>"23"||n>"59"||d>"59"?!1:!0)):!1},throwErrorWithCode=function(e,t){var i=new Error(t);throw i.code=e,i.failedValidation=!0,i};module.exports.validateAgainstSchema=function(e,t,i){var a=function(e){delete e.params,e.inner&&_.each(e.inner,function(e){a(e)})},r=_.isPlainObject(e)?_.cloneDeep(e):e;_.isUndefined(i)&&(i=helpers.createJsonValidator([r]));var n=i.validate(t,r);if(!n)try{throwErrorWithCode("SCHEMA_VALIDATION_FAILED","Failed schema validation")}catch(o){throw o.results={errors:_.map(i.getLastErrors(),function(e){return a(e),e}),warnings:[]},o}};var validateArrayType=module.exports.validateArrayType=function(e){"array"===e.type&&_.isUndefined(e.items)&&throwErrorWithCode("OBJECT_MISSING_REQUIRED_PROPERTY","Missing required property: items")};module.exports.validateContentType=function(e,t,i){var a=i.headers["content-type"]||"application/octet-stream",r=_.union(t,e);if(a=a.split(";")[0],r.length>0&&-1!==["POST","PUT"].indexOf(i.method)&&-1===r.indexOf(a))throw new Error("Invalid content type ("+a+").  These are valid: "+r.join(", "))};var validateEnum=module.exports.validateEnum=function(e,t){_.isUndefined(t)||_.isUndefined(e)||-1!==t.indexOf(e)||throwErrorWithCode("ENUM_MISMATCH","Not an allowable value ("+t.join(", ")+"): "+e)},validateMaximum=module.exports.validateMaximum=function(e,t,i,a){var r,n,o=a===!0?"MAXIMUM_EXCLUSIVE":"MAXIMUM";_.isUndefined(a)&&(a=!1),"integer"===i?n=parseInt(e,10):"number"===i&&(n=parseFloat(e)),_.isUndefined(t)||(r=parseFloat(t),a&&n>=r?throwErrorWithCode(o,"Greater than or equal to the configured maximum ("+t+"): "+e):n>r&&throwErrorWithCode(o,"Greater than the configured maximum ("+t+"): "+e))},validateMaxItems=module.exports.validateMaxItems=function(e,t){!_.isUndefined(t)&&e.length>t&&throwErrorWithCode("ARRAY_LENGTH_LONG","Array is too long ("+e.length+"), maximum "+t)},validateMaxLength=module.exports.validateMaxLength=function(e,t){!_.isUndefined(t)&&e.length>t&&throwErrorWithCode("MAX_LENGTH","String is too long ("+e.length+" chars), maximum "+t)},validateMaxProperties=module.exports.validateMaxProperties=function(e,t){var i=_.isPlainObject(e)?Object.keys(e).length:0;!_.isUndefined(t)&&i>t&&throwErrorWithCode("MAX_PROPERTIES","Number of properties is too many ("+i+" properties), maximum "+t)},validateMinimum=module.exports.validateMinimum=function(e,t,i,a){var r,n,o=a===!0?"MINIMUM_EXCLUSIVE":"MINIMUM";_.isUndefined(a)&&(a=!1),"integer"===i?n=parseInt(e,10):"number"===i&&(n=parseFloat(e)),_.isUndefined(t)||(r=parseFloat(t),a&&r>=n?throwErrorWithCode(o,"Less than or equal to the configured minimum ("+t+"): "+e):r>n&&throwErrorWithCode(o,"Less than the configured minimum ("+t+"): "+e))},validateMinItems=module.exports.validateMinItems=function(e,t){!_.isUndefined(t)&&e.length<t&&throwErrorWithCode("ARRAY_LENGTH_SHORT","Array is too short ("+e.length+"), minimum "+t)},validateMinLength=module.exports.validateMinLength=function(e,t){!_.isUndefined(t)&&e.length<t&&throwErrorWithCode("MIN_LENGTH","String is too short ("+e.length+" chars), minimum "+t)},validateMinProperties=module.exports.validateMinProperties=function(e,t){var i=_.isPlainObject(e)?Object.keys(e).length:0;!_.isUndefined(t)&&t>i&&throwErrorWithCode("MIN_PROPERTIES","Number of properties is too few ("+i+" properties), minimum "+t)},validateMultipleOf=module.exports.validateMultipleOf=function(e,t){_.isUndefined(t)||e%t===0||throwErrorWithCode("MULTIPLE_OF","Not a multiple of "+t)},validatePattern=module.exports.validatePattern=function(e,t){!_.isUndefined(t)&&_.isNull(e.match(new RegExp(t)))&&throwErrorWithCode("PATTERN","Does not match required pattern: "+t)};module.exports.validateRequiredness=function(e,t){!_.isUndefined(t)&&t===!0&&_.isUndefined(e)&&throwErrorWithCode("REQUIRED","Is required")};var validateTypeAndFormat=module.exports.validateTypeAndFormat=function e(t,i,a,r){var n=!0;if(_.isArray(t))_.each(t,function(t,r){e(t,i,a,!0)||throwErrorWithCode("INVALID_TYPE","Value at index "+r+" is not a valid "+i+": "+t)});else switch(i){case"boolean":n=_.isBoolean(t)||-1!==["false","true"].indexOf(t);break;case"integer":n=!_.isNaN(parseInt(t,10));break;case"number":n=!_.isNaN(parseFloat(t));break;case"string":if(!_.isUndefined(a))switch(a){case"date":n=isValidDate(t);break;case"date-time":n=isValidDateTime(t)}}return r?n:void(n||throwErrorWithCode("INVALID_TYPE","Not a valid "+(_.isUndefined(a)?"":a+" ")+i+": "+t))},validateUniqueItems=module.exports.validateUniqueItems=function(e,t){_.isUndefined(t)||_.uniq(e).length===e.length||throwErrorWithCode("ARRAY_UNIQUE","Does not allow duplicate values: "+e.join(", "))};module.exports.validateSchemaConstraints=function(e,t,i,a){var r=function o(e){var t=e;return t.schema&&(i=i.concat(["schema"]),t=o(t.schema)),t};t=r(t);try{if("array"===t.type&&validateArrayType(t),_.isUndefined(a)&&(a="1.2"===e?t.defaultValue:t.default,i=i.concat(["1.2"===e?"defaultValue":"default"])),_.isUndefined(a))return;"array"===t.type?_.isUndefined(t.items)?validateTypeAndFormat(a,t.type,t.format):validateTypeAndFormat(a,"array"===t.type?t.items.type:t.type,"array"===t.type&&t.items.format?t.items.format:t.format):validateTypeAndFormat(a,t.type,t.format),validateEnum(a,t.enum),validateMaximum(a,t.maximum,t.type,t.exclusiveMaximum),validateMaxItems(a,t.maxItems),validateMaxLength(a,t.maxLength),validateMaxProperties(a,t.maxProperties),validateMinimum(a,t.minimum,t.type,t.exclusiveMinimum),validateMinItems(a,t.minItems),validateMinLength(a,t.minLength),validateMinProperties(a,t.minProperties),validateMultipleOf(a,t.multipleOf),validatePattern(a,t.pattern),validateUniqueItems(a,t.uniqueItems)}catch(n){throw n.path=i,n}};
},{"./helpers":2,"lodash":10}],4:[function(require,module,exports){
...
},{"lodash":10,"superagent":7,"traverse":12}],7:[function(require,module,exports){
...
},{"./Errors":13,"_process":5}],18:[function(require,module,exports){
...
},{"./Report":17,"./SchemaCompilation":19,"./SchemaValidation":20}],19:[function(require,module,exports){
...
},{"./Report":17,"./SchemaCache":18}],20:[function(require,module,exports){
...
},{"./FormatValidators":14,"./JsonValidation":15,"./Report":17,"./Utils":21}],21:[function(require,module,exports){
