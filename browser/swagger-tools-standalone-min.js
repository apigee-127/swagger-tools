...
(function (process){
"use strict";function Report(r){this.parentReport=r instanceof Report?r:void 0,this.options=r instanceof Report?r.options:r||{},this.errors=[],this.path=[],this.asyncTasks=[]}var Errors=require("./Errors");Report.prototype.isValid=function(){if(this.asyncTasks.length>0)throw new Error("Async tasks pending, can't answer isValid");return 0===this.errors.length},Report.prototype.addAsyncTask=function(r,t,o){this.asyncTasks.push([r,t,o])},Report.prototype.processAsyncTasks=function(r,t){function o(){process.nextTick(function(){var r=0===p.errors.length,o=r?void 0:p.errors;t(o,r)})}function e(r){return function(t){a||(r(t),0===--s&&o())}}var n=r||2e3,s=this.asyncTasks.length,i=s,a=!1,p=this;if(0===s||this.errors.length>0)return void o();for(;i--;){var h=this.asyncTasks[i];h[0].apply(null,h[1].concat(e(h[2])))}setTimeout(function(){s>0&&(a=!0,p.addError("ASYNC_TIMEOUT",[s,n]),t(p.errors,!1))},n)},Report.prototype.getPath=function(){var r=[];return this.parentReport&&(r=r.concat(this.parentReport.path)),r=r.concat(this.path),this.options.reportPathAsArray!==!0&&(r="#/"+r.map(function(r){return r.replace("~","~0").replace("/","~1")}).join("/")),r},Report.prototype.addError=function(r,t,o,e){if(!r)throw new Error("No errorCode passed into addError()");if(!Errors[r])throw new Error("No errorMessage known for code "+r);t=t||[];for(var n=t.length,s=Errors[r];n--;)s=s.replace("{"+n+"}",JSON.stringify(t[n])||"undefined");var i={code:r,params:t,message:s,path:this.getPath()};if(e&&(i.description=e),null!=o){for(Array.isArray(o)||(o=[o]),i.inner=[],n=o.length;n--;)for(var a=o[n],p=a.errors.length;p--;)i.inner.push(a.errors[p]);0===i.inner.length&&(i.inner=void 0)}this.errors.push(i)},module.exports=Report;


}).call(this,require('_process'))
},{"./Errors":65,"_process":5}],70:[function(require,module,exports){
...
},{"./Report":69,"./SchemaCompilation":71,"./SchemaValidation":72}],71:[function(require,module,exports){
