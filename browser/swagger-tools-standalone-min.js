...
(function(e){"use strict";var r=require("lodash"),n=require("async"),i=require("./helpers"),t=require("json-refs"),o=require("spark-md5"),s=require("swagger-converter"),a=require("traverse"),c=require("./validators");r.isPlainObject(s)&&(s=e.SwaggerConverter.convert);var u={},d=function _(e,i,o){var s=r.reduce(t.findRefs(i),function(e,r,n){return t.isRemotePointer(n)&&e.push(r.split("#")[0]),e},[]),a=function(r,n){t.resolveRefs({$ref:r},function(r,i){return r?n(r):void _(e,i,function(e,r){n(e,r)})})};s.length>0?n.map(s,a,function(n,i){return n?o(n):(r.each(i,function(r,n){e.setRemoteReference(s[n],r)}),void o())}):o()},f=function(e,r,n,i){i.push({code:e,message:r,path:n})},h=function(e,n,o,s,a){var c,u,d,h,p,l=!0,g=i.getSwaggerVersion(e.resolved),m=r.isArray(n)?n:t.pathFromPointer(n),v=r.isArray(n)?t.pathToPointer(n):n,w=r.isArray(o)?o:t.pathFromPointer(o),E=r.isArray(o)?t.pathToPointer(o):o;return 0===m.length?(f("INVALID_REFERENCE","Not a valid JSON Reference",w,s.errors),!1):(u=e.definitions[v],p=m[0],c="securityDefinitions"===p?"SECURITY_DEFINITION":p.substring(0,p.length-1).toUpperCase(),d="1.2"===g?m[m.length-1]:v,h="securityDefinitions"===p?"Security definition":c.charAt(0)+c.substring(1).toLowerCase(),["authorizations","securityDefinitions"].indexOf(m[0])>-1&&"scopes"===m[2]&&(c+="_SCOPE",h+=" scope"),r.isUndefined(u)?(a||f("UNRESOLVABLE_"+c,h+" could not be resolved: "+d,w,s.errors),l=!1):(r.isUndefined(u.references)&&(u.references=[]),u.references.push(E)),l)},p=function q(e,n){var i,o,s="Composed "+("1.2"===e.swaggerVersion?t.pathFromPointer(n).pop():n),c=e.definitions[n],u=a(e.original),d=a(e.resolved);return c?(o=r.cloneDeep(u.get(t.pathFromPointer(n))),i=r.cloneDeep(d.get(t.pathFromPointer(n))),"1.2"===e.swaggerVersion&&(c.lineage.length>0&&(i.allOf=[],r.each(c.lineage,function(r){i.allOf.push(q(e,r))})),delete i.subTypes,r.each(i.properties,function(n,i){var s=o.properties[i];r.each(["maximum","minimum"],function(e){r.isString(n[e])&&(n[e]=parseFloat(n[e]))}),r.each(t.findRefs(s),function(r,i){var o="#/models/"+r,s=e.definitions[o],c=t.pathFromPointer(i);s.lineage.length>0?a(n).set(c.slice(0,c.length-1),q(e,o)):a(n).set(c.slice(0,c.length-1).concat("title"),"Composed "+r)})})),i=a(i).map(function(e){"id"===this.key&&r.isString(e)&&this.remove()}),i.title=s,i):void 0},l=function(e,r,n,i,t){f("UNUSED_"+r,n+" is defined but is not used: "+e,i,t)},g=function(e){var n=o.hash(JSON.stringify(e)),t=u[n]||r.find(u,function(e){return e.resolvedId===n});return t||(t=u[n]={definitions:{},original:e,resolved:void 0,swaggerVersion:i.getSwaggerVersion(e)}),t},m=function(e,r){var n=new Error("The Swagger document(s) are invalid");n.errors=e.errors,n.failedValidation=!0,n.warnings=e.warnings,e.apiDeclarations&&(n.apiDeclarations=e.apiDeclarations),r(n)},v=function(e){var n=e.match(/\{(.*?)\}/g),i=[],t=e;return n&&r.each(n,function(e,r){t=t.replace(e,"{"+r+"}"),i.push(e.replace(/[{}]/g,""))}),{path:t,args:i}},w=function(e,n,i,t,o,s){!r.isUndefined(e)&&e.indexOf(n)>-1&&f("DUPLICATE_"+i,t+" already defined: "+n,o,s)},E=function(e,r,n,i,t){try{c.validateSchemaConstraints(e.swaggerVersion,r,n,void 0)}catch(o){t||f(o.code,o.message,o.path,i.errors)}},b=function(e,n){var i=e.swaggerVersion,o=function(r){var n=t.pathToPointer(r),i=e.definitions[n];return i||(i=e.definitions[n]={references:[]},["definitions","models"].indexOf(t.pathFromPointer(n)[0])>-1&&(i.cyclical=!1,i.lineage=void 0,i.parents=[])),i},s=function(e){return"1.2"===i?t.pathFromPointer(e).pop():e},c=function p(n,i,t){var o=e.definitions[i||n];o&&r.each(o.parents,function(e){t.push(e),n!==e&&p(n,e,t)})},u="1.2"===i?"authorizations":"securityDefinitions",d="1.2"===i?"models":"definitions";switch(r.each(e.resolved[u],function(e,t){var s=[u,t];("1.2"!==i||e.type)&&(o(s),r.reduce(e.scopes,function(e,r,t){var a="1.2"===i?r.scope:t,c=s.concat(["scopes",t.toString()]),u=o(s.concat(["scopes",a]));return u.scopePath=c,w(e,a,"AUTHORIZATION_SCOPE_DEFINITION","Authorization scope definition","1.2"===i?c.concat("scope"):c,n.warnings),e.push(a),e},[]))}),r.each(e.resolved[d],function(s,a){var c=[d,a],u=o(c);if("1.2"===i&&a!==s.id&&f("MODEL_ID_MISMATCH","Model id does not match id in models object: "+s.id,c.concat("id"),n.errors),r.isUndefined(u.lineage))switch(i){case"1.2":r.each(s.subTypes,function(r,i){var s=["models",r],a=t.pathToPointer(s),u=e.definitions[a],f=c.concat(["subTypes",i.toString()]);!u&&e.resolved[d][r]&&(u=o(s)),h(e,s,f,n)&&u.parents.push(t.pathToPointer(c))});break;default:r.each(e.original[d][a].allOf,function(i,s){var a,d,f=c.concat(["allOf",s.toString()]);r.isUndefined(i.$ref)||t.isRemotePointer(i.$ref)?d=c.concat(["allOf",s.toString()]):(a=o(t.pathFromPointer(i.$ref)),d=t.pathFromPointer(i.$ref)),u.parents.push(t.pathToPointer(d)),a&&h(e,d,f,n)})}}),i){case"2.0":r.each(e.resolved.parameters,function(r,i){var t=["parameters",i];o(t),E(e,r,t,n)}),r.each(e.resolved.responses,function(r,i){var t=["responses",i];o(t),E(e,r,t,n)})}r.each(e.definitions,function(o,u){var d,h,p,l=t.pathFromPointer(u),g=a(e.original).get(l),m=l[0],v=m.substring(0,m.length-1).toUpperCase(),w=v.charAt(0)+v.substring(1).toLowerCase();-1!==["definitions","models"].indexOf(m)&&(d=[],h=[],p=o.lineage,r.isUndefined(p)&&(p=[],c(u,void 0,p),p.reverse(),o.lineage=r.cloneDeep(p),o.cyclical=p.length>1&&p[0]===u),o.parents.length>1&&"1.2"===i&&f("MULTIPLE_"+v+"_INHERITANCE","Child "+v.toLowerCase()+" is sub type of multiple models: "+r.map(o.parents,function(e){return s(e)}).join(" && "),l,n.errors),o.cyclical&&f("CYCLICAL_"+v+"_INHERITANCE",w+" has a circular inheritance: "+r.map(p,function(e){return s(e)}).join(" -> ")+" -> "+s(u),l.concat("1.2"===i?"subTypes":"allOf"),n.errors),r.each(p.slice(o.cyclical?1:0),function(n){var i=a(e.resolved).get(t.pathFromPointer(n));r.each(Object.keys(i.properties),function(e){-1===h.indexOf(e)&&h.push(e)})}),E(e,g,l,n),r.each(g.properties,function(i,t){var o=l.concat(["properties",t]);r.isUndefined(i)||(E(e,i,o,n),h.indexOf(t)>-1?f("CHILD_"+v+"_REDECLARES_PROPERTY","Child "+v.toLowerCase()+" declares property already declared by ancestor: "+t,o,n.errors):d.push(t))}),r.each(g.required||[],function(e,r){-1===h.indexOf(e)&&-1===d.indexOf(e)&&f("MISSING_REQUIRED_MODEL_PROPERTY","Model requires property but it is not defined: "+e,l.concat(["required",r.toString()]),n.errors)}))}),r.each(t.findRefs(e.original),function(r,i){"1.2"===e.swaggerVersion&&(r="#/models/"+r),t.isRemotePointer(r)||h(e,r,i,n)})},j=function(e,n,i,t,o,s){r.isUndefined(e)||-1!==e.indexOf(n)||f("UNRESOLVABLE_"+i,t+" could not be resolved: "+n,o,s)},O=function(e,n,i,t){var o="1.2"===e.swaggerVersion?"AUTHORIZATION":"SECURITY_DEFINITION",s="AUTHORIZATION"===o?"Authorization":"Security definition";"1.2"===e.swaggerVersion?r.reduce(n,function(n,a,c){var u="#/authorizations/"+c,d=i.concat([c]);return h(e,u,d,t)&&r.reduce(a,function(r,n,i){var a=d.concat(i.toString(),"scope"),c=u+"/scopes/"+n.scope;return w(r,n.scope,o+"_SCOPE_REFERENCE",s+" scope reference",a,t.warnings),h(e,c,a,t),r.concat(n.scope)},[]),n.concat(c)},[]):r.reduce(n,function(n,a,c){return r.each(a,function(a,u){var d="#/securityDefinitions/"+u,f=i.concat(c.toString(),u);w(n,u,o+"_REFERENCE",s+" reference",f,t.warnings),n.push(u),h(e,d,f,t)&&r.each(a,function(r,n){h(e,d+"/scopes/"+r,f.concat(n.toString()),t)})}),n},[])},y=function(e,n){var s,c=g(e),u=i.getSwaggerVersion(e);c.resolved?n():("1.2"===u&&(e=r.cloneDeep(e),s=a(e),r.each(t.findRefs(e),function(e,r){s.set(t.pathFromPointer(r),"#/models/"+e)})),t.resolveRefs(e,function(e,r){return e?n(e):(c.resolved=r,c.resolvedId=o.hash(JSON.stringify(r)),void n())}))},P=function(e,n,t,o){var s=r.isString(n)?e.validators[n]:i.createJsonValidator(),a=function(){try{c.validateAgainstSchema(n,t,s)}catch(e){return e.failedValidation?o(void 0,e.results):o(e)}y(t,function(e){return o(e)})};d(s,t,function(e){return e?o(e):void a()})},T=function(e,n){r.each(e.definitions,function(r,i){var o=t.pathFromPointer(i),s=o[0].substring(0,o[0].length-1),a="1.2"===e.swaggerVersion?o[o.length-1]:i,c="securityDefinition"===s?"SECURITY_DEFINITION":s.toUpperCase(),u="securityDefinition"===s?"Security definition":s.charAt(0).toUpperCase()+s.substring(1);0===r.references.length&&(r.scopePath&&(c+="_SCOPE",u+=" scope",o=r.scopePath),l(a,c,u,o,n.warnings))})},S=function(e,n,i,t,o,s,a){var c=[];r.reduce(t,function(e,t,a){var u=o.concat(["parameters",a.toString()]);if(!r.isUndefined(t))return w(e,t.name,"PARAMETER","Parameter",u.concat("name"),s.errors),("path"===t.paramType||"path"===t["in"])&&(-1===i.args.indexOf(t.name)&&f("UNRESOLVABLE_API_PATH_PARAMETER","API path parameter could not be resolved: "+t.name,u.concat("name"),s.errors),c.push(t.name)),E(n,t,u,s,t.skipErrors),e.concat(t.name)},[]),(r.isUndefined(a)||a===!1)&&r.each(r.difference(i.args,c),function(e){f("MISSING_API_PATH_PARAMETER","API requires path parameter but it is not defined: "+e,"1.2"===n.swaggerVersion?o.slice(0,2).concat("path"):o,s.errors)})},R=function(e,n,i,t){var o=[],s=g(n),a=[],c={errors:[],warnings:[],apiDeclarations:[]};a=r.reduce(n.apis,function(e,r,n){return w(e,r.path,"RESOURCE_PATH","Resource path",["apis",n.toString(),"path"],c.errors),e.push(r.path),e},[]),b(s,c),o=r.reduce(i,function(n,i,t){var u=c.apiDeclarations[t]={errors:[],warnings:[]},d=g(i);return w(n,i.resourcePath,"RESOURCE_PATH","Resource path",["resourcePath"],u.errors),-1===o.indexOf(i.resourcePath)&&(j(a,i.resourcePath,"RESOURCE_PATH","Resource path",["resourcePath"],u.errors),n.push(i.resourcePath)),b(d,u),r.reduce(i.apis,function(n,i,t){var o=["apis",t.toString()],a=v(i.path);return n.indexOf(a.path)>-1?f("DUPLICATE_API_PATH","API path (or equivalent) already defined: "+i.path,o.concat("path"),u.errors):n.push(a.path),r.reduce(i.operations,function(n,i,t){var c=o.concat(["operations",t.toString()]);return w(n,i.method,"OPERATION_METHOD","Operation method",c.concat("method"),u.errors),n.push(i.method),-1===e.primitives.indexOf(i.type)&&"1.2"===e.version&&h(d,"#/models/"+i.type,c.concat("type"),u),O(s,i.authorizations,c.concat("authorizations"),u),E(d,i,c,u),S(e,d,a,i.parameters,c,u),r.reduce(i.responseMessages,function(e,r,n){var i=c.concat(["responseMessages",n.toString()]);return w(e,r.code,"RESPONSE_MESSAGE_CODE","Response message code",i.concat(["code"]),u.errors),r.responseModel&&h(d,"#/models/"+r.responseModel,i.concat("responseModel"),u),e.concat(r.code)},[]),n},[]),n},[]),T(d,u),n},[]),T(s,c),r.each(r.difference(a,o),function(e){var r=a.indexOf(e);l(n.apis[r].path,"RESOURCE_PATH","Resource path",["apis",r.toString(),"path"],c.errors)}),t(void 0,c)},U=function(e,n,i){var t=g(n),o={errors:[],warnings:[]};b(t,o),O(t,n.security,["security"],o),r.reduce(t.resolved.paths,function(n,i,s){var a=["paths",s],c=v(s);return n.indexOf(c.path)>-1&&f("DUPLICATE_API_PATH","API path (or equivalent) already defined: "+s,a,o.errors),S(e,t,c,i.parameters,a,o,!0),r.each(i,function(n,s){var u=[],d=a.concat(s),f=[];"parameters"!==s&&(O(t,n.security,d.concat("security"),o),r.each(n.parameters,function(e){u.push(e),f.push(e.name+":"+e["in"])}),r.each(i.parameters,function(e){var n=r.cloneDeep(e);n.skipErrors=!0,-1===f.indexOf(e.name+":"+e["in"])&&u.push(n)}),S(e,t,c,u,d,o),r.each(n.responses,function(e,r){E(t,e,d.concat("responses",r),o)}))}),n.concat(c.path)},[]),T(t,o),i(void 0,o)},A=function(e,r,n,t){var o=function(e,r){t(e,i.formatResults(r))};"1.2"===e.version?R(e,r,n,o):U(e,r,o)},I=function(e,i,t,o){P(e,"1.2"===e.version?"resourceListing.json":"schema.json",i,function(i,s){return i?o(i):void(s||"1.2"!==e.version?o(void 0,s):(s={errors:[],warnings:[],apiDeclarations:[]},n.map(t,function(r,n){P(e,"apiDeclaration.json",r,n)},function(e,n){return e?o(e):(r.each(n,function(e,r){s.apiDeclarations[r]=e}),void o(void 0,s))})))})},D=function(e){var n=function(e,n){return r.reduce(n,function(e,r,n){return e[n]=i.createJsonValidator(r),e}.bind(this),{})},t=function(e){var n=r.cloneDeep(this.schemas[e]);return n.id=e,n}.bind(this),o=["string","number","boolean","integer","array"];switch(e){case"1.2":this.docsUrl="https://github.com/swagger-api/swagger-spec/blob/master/versions/1.2.md",this.primitives=r.union(o,["void","File"]),this.schemasUrl="https://github.com/swagger-api/swagger-spec/tree/master/schemas/v1.2",this.schemas={"apiDeclaration.json":require("../schemas/1.2/apiDeclaration.json"),"authorizationObject.json":require("../schemas/1.2/authorizationObject.json"),"dataType.json":require("../schemas/1.2/dataType.json"),"dataTypeBase.json":require("../schemas/1.2/dataTypeBase.json"),"infoObject.json":require("../schemas/1.2/infoObject.json"),"modelsObject.json":require("../schemas/1.2/modelsObject.json"),"oauth2GrantType.json":require("../schemas/1.2/oauth2GrantType.json"),"operationObject.json":require("../schemas/1.2/operationObject.json"),"parameterObject.json":require("../schemas/1.2/parameterObject.json"),"resourceListing.json":require("../schemas/1.2/resourceListing.json"),"resourceObject.json":require("../schemas/1.2/resourceObject.json")},this.validators=n(this,{"apiDeclaration.json":r.map(["dataTypeBase.json","modelsObject.json","oauth2GrantType.json","authorizationObject.json","parameterObject.json","operationObject.json","apiDeclaration.json"],t),"resourceListing.json":r.map(["resourceObject.json","infoObject.json","oauth2GrantType.json","authorizationObject.json","resourceListing.json"],t)});break;case"2.0":this.docsUrl="https://github.com/swagger-api/swagger-spec/blob/master/versions/2.0.md",this.primitives=r.union(o,["file"]),this.schemasUrl="https://github.com/swagger-api/swagger-spec/tree/master/schemas/v2.0",this.schemas={"schema.json":require("../schemas/2.0/schema.json")},this.validators=n(this,{"schema.json":[t("schema.json")]});break;default:throw new Error(e+" is an unsupported Swagger specification version")}this.version=e};D.prototype.validate=function(e,n,t){switch(this.version){case"1.2":if(r.isUndefined(e))throw new Error("resourceListing is required");if(!r.isPlainObject(e))throw new TypeError("resourceListing must be an object");if(r.isUndefined(n))throw new Error("apiDeclarations is required");if(!r.isArray(n))throw new TypeError("apiDeclarations must be an array");break;case"2.0":if(r.isUndefined(e))throw new Error("swaggerObject is required");if(!r.isPlainObject(e))throw new TypeError("swaggerObject must be an object")}if("2.0"===this.version&&(t=arguments[1]),r.isUndefined(t))throw new Error("callback is required");if(!r.isFunction(t))throw new TypeError("callback must be a function");"2.0"===this.version&&(n=[]),I(this,e,n,function(r,o){r||i.formatResults(o)?t(r,o):A(this,e,n,t)}.bind(this))},D.prototype.composeModel=function(e,n,t){var o=i.getSwaggerVersion(e),s=function(r,o){var s;return r?t(r):i.getErrorCount(o)>0?m(o,t):(s=g(e),o={errors:[],warnings:[]},b(s,o),s.definitions[n]?i.getErrorCount(o)>0?m(o,t):void t(void 0,p(s,n)):t())};switch(this.version){case"1.2":if(r.isUndefined(e))throw new Error("apiDeclaration is required");if(!r.isPlainObject(e))throw new TypeError("apiDeclaration must be an object");if(r.isUndefined(n))throw new Error("modelId is required");break;case"2.0":if(r.isUndefined(e))throw new Error("swaggerObject is required");if(!r.isPlainObject(e))throw new TypeError("swaggerObject must be an object");if(r.isUndefined(n))throw new Error("modelRef is required")}if(r.isUndefined(t))throw new Error("callback is required");if(!r.isFunction(t))throw new TypeError("callback must be a function");if("#"!==n.charAt(0)){if("1.2"!==this.version)throw new Error("modelRef must be a JSON Pointer");n="#/models/"+n}"1.2"===o?P(this,"apiDeclaration.json",e,s):this.validate(e,s)},D.prototype.validateModel=function(e,n,i,t){switch(this.version){case"1.2":if(r.isUndefined(e))throw new Error("apiDeclaration is required");if(!r.isPlainObject(e))throw new TypeError("apiDeclaration must be an object");if(r.isUndefined(n))throw new Error("modelId is required");break;case"2.0":if(r.isUndefined(e))throw new Error("swaggerObject is required");if(!r.isPlainObject(e))throw new TypeError("swaggerObject must be an object");if(r.isUndefined(n))throw new Error("modelRef is required")}if(r.isUndefined(i))throw new Error("data is required");if(r.isUndefined(t))throw new Error("callback is required");if(!r.isFunction(t))throw new TypeError("callback must be a function");this.composeModel(e,n,function(e,r){return e?t(e):void P(this,r,i,t)}.bind(this))},D.prototype.resolve=function(e,n,o){var s,c,u=function(e){return r.isString(n)?o(void 0,a(e).get(t.pathFromPointer(n))):o(void 0,e)};if(r.isUndefined(e))throw new Error("document is required");if(!r.isPlainObject(e))throw new TypeError("document must be an object");if(2===arguments.length&&(o=arguments[1],n=void 0),!r.isUndefined(n)&&!r.isString(n))throw new TypeError("ptr must be a JSON Pointer string");if(r.isUndefined(o))throw new Error("callback is required");if(!r.isFunction(o))throw new TypeError("callback must be a function");if(s=g(e),"1.2"===s.swaggerVersion)throw new Error("Swagger 1.2 is not supported");return s.resolved?u(s.resolved):(c="1.2"===s.swaggerVersion?r.find(["basePath","consumes","models","produces","resourcePath"],function(n){return!r.isUndefined(e[n])})?"apiDeclaration.json":"resourceListing.json":"schema.json",void this.validate(e,function(e,r){return e?o(e):i.getErrorCount(r)>0?m(r,o):u(s.resolved)}))},D.prototype.convert=function(e,n,t,o){var a=function(e,r){o(void 0,s(e,r))}.bind(this);if("1.2"!==this.version)throw new Error("Specification#convert only works for Swagger 1.2");if(r.isUndefined(e))throw new Error("resourceListing is required");if(!r.isPlainObject(e))throw new TypeError("resourceListing must be an object");if(r.isUndefined(n)&&(n=[]),!r.isArray(n))throw new TypeError("apiDeclarations must be an array");if(arguments.length<4&&(o=arguments[arguments.length-1]),r.isUndefined(o))throw new Error("callback is required");if(!r.isFunction(o))throw new TypeError("callback must be a function");t===!0?a(e,n):this.validate(e,n,function(r,t){return r?o(r):i.getErrorCount(t)>0?m(t,o):void a(e,n)})},module.exports.v1=module.exports.v1_2=new D("1.2"),module.exports.v2=module.exports.v2_0=new D("2.0")}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{});
