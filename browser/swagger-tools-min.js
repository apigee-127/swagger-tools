...
(function(e){"use strict";var n="undefined"!=typeof window?window._:"undefined"!=typeof e?e._:null,t=require("./helpers"),i=/^([0-9]{4})-([0-9]{2})-([0-9]{2})$/,a=/^([0-9]{2}):([0-9]{2}):([0-9]{2})(.[0-9]+)?(z|([+-][0-9]{2}:[0-9]{2}))$/,o=function(e){var t,a,o;return n.isString(e)||(e=e.toString()),a=i.exec(e),null===a?!1:(t=a[3],o=a[2],"01">o||o>"12"||"01">t||t>"31"?!1:!0)},r=function(e){var t,i,r,s,d,l,u;return n.isString(e)||(e=e.toString()),l=e.toLowerCase().split("t"),i=l[0],r=l.length>1?l[1]:void 0,o(i)?(s=a.exec(r),null===s?!1:(t=s[1],d=s[2],u=s[3],t>"23"||d>"59"||u>"59"?!1:!0)):!1},s=function(e,n){var t=new Error(n);throw t.code=e,t.failedValidation=!0,t};module.exports.validateAgainstSchema=function(e,i,a){var o=function(e){delete e.params,e.inner&&n.each(e.inner,function(e){o(e)})},r=n.isPlainObject(e)?n.cloneDeep(e):e;n.isUndefined(a)&&(a=t.createJsonValidator([r]));var d=a.validate(i,r);if(!d)try{s("SCHEMA_VALIDATION_FAILED","Failed schema validation")}catch(l){throw l.results={errors:n.map(a.getLastErrors(),function(e){return o(e),e}),warnings:[]},l}};var d=module.exports.validateArrayType=function(e){"array"===e.type&&n.isUndefined(e.items)&&s("OBJECT_MISSING_REQUIRED_PROPERTY","Missing required property: items")};module.exports.validateContentType=function(e,t,i){var a="function"==typeof i.end,o=a?i.getHeader("content-type"):i.headers["content-type"],r=n.union(e,t);if(o||(o=a?"text/plain":"application/octet-stream"),o=o.split(";")[0],r.length>0&&(a?!0:-1!==["POST","PUT"].indexOf(i.method))&&-1===r.indexOf(o))throw new Error("Invalid content type ("+o+").  These are valid: "+r.join(", "))};var l=module.exports.validateEnum=function(e,t){n.isUndefined(t)||n.isUndefined(e)||-1!==t.indexOf(e)||s("ENUM_MISMATCH","Not an allowable value ("+t.join(", ")+"): "+e)},u=module.exports.validateMaximum=function(e,t,i,a){var o,r,d=a===!0?"MAXIMUM_EXCLUSIVE":"MAXIMUM";n.isUndefined(a)&&(a=!1),"integer"===i?r=parseInt(e,10):"number"===i&&(r=parseFloat(e)),n.isUndefined(t)||(o=parseFloat(t),a&&r>=o?s(d,"Greater than or equal to the configured maximum ("+t+"): "+e):r>o&&s(d,"Greater than the configured maximum ("+t+"): "+e))},m=module.exports.validateMaxItems=function(e,t){!n.isUndefined(t)&&e.length>t&&s("ARRAY_LENGTH_LONG","Array is too long ("+e.length+"), maximum "+t)},f=module.exports.validateMaxLength=function(e,t){!n.isUndefined(t)&&e.length>t&&s("MAX_LENGTH","String is too long ("+e.length+" chars), maximum "+t)},c=module.exports.validateMaxProperties=function(e,t){var i=n.isPlainObject(e)?Object.keys(e).length:0;!n.isUndefined(t)&&i>t&&s("MAX_PROPERTIES","Number of properties is too many ("+i+" properties), maximum "+t)},p=module.exports.validateMinimum=function(e,t,i,a){var o,r,d=a===!0?"MINIMUM_EXCLUSIVE":"MINIMUM";n.isUndefined(a)&&(a=!1),"integer"===i?r=parseInt(e,10):"number"===i&&(r=parseFloat(e)),n.isUndefined(t)||(o=parseFloat(t),a&&o>=r?s(d,"Less than or equal to the configured minimum ("+t+"): "+e):o>r&&s(d,"Less than the configured minimum ("+t+"): "+e))},h=module.exports.validateMinItems=function(e,t){!n.isUndefined(t)&&e.length<t&&s("ARRAY_LENGTH_SHORT","Array is too short ("+e.length+"), minimum "+t)},v=module.exports.validateMinLength=function(e,t){!n.isUndefined(t)&&e.length<t&&s("MIN_LENGTH","String is too short ("+e.length+" chars), minimum "+t)},x=module.exports.validateMinProperties=function(e,t){var i=n.isPlainObject(e)?Object.keys(e).length:0;!n.isUndefined(t)&&t>i&&s("MIN_PROPERTIES","Number of properties is too few ("+i+" properties), minimum "+t)},g=module.exports.validateMultipleOf=function(e,t){n.isUndefined(t)||e%t===0||s("MULTIPLE_OF","Not a multiple of "+t)},U=module.exports.validatePattern=function(e,t){!n.isUndefined(t)&&n.isNull(e.match(new RegExp(t)))&&s("PATTERN","Does not match required pattern: "+t)};module.exports.validateRequiredness=function(e,t){!n.isUndefined(t)&&t===!0&&n.isUndefined(e)&&s("REQUIRED","Is required")};var I=module.exports.validateTypeAndFormat=function y(e,t,i,a){var d=!0;if(n.isArray(e))n.each(e,function(e,n){y(e,t,i,!0)||s("INVALID_TYPE","Value at index "+n+" is not a valid "+t+": "+e)});else switch(t){case"boolean":d=n.isBoolean(e)||-1!==["false","true"].indexOf(e);break;case"integer":d=!n.isNaN(parseInt(e,10));break;case"number":d=!n.isNaN(parseFloat(e));break;case"string":if(!n.isUndefined(i))switch(i){case"date":d=o(e);break;case"date-time":d=r(e)}break;case"void":d=n.isUndefined(e)}return a?d:void(d||s("INVALID_TYPE","void"!==t?"Not a valid "+(n.isUndefined(i)?"":i+" ")+t+": "+e:"Void does not allow a value"))},M=module.exports.validateUniqueItems=function(e,t){n.isUndefined(t)||n.uniq(e).length===e.length||s("ARRAY_UNIQUE","Does not allow duplicate values: "+e.join(", "))};module.exports.validateSchemaConstraints=function(e,t,i,a){var o=function y(e){var n=e;return n.schema&&(i=i.concat(["schema"]),n=y(n.schema)),n};if(!n.isUndefined(t)){var r=t.type;r||(t.schema?(t=o(t),r=t.type||"object"):r="void");try{if("array"===r&&d(t),n.isUndefined(a)&&(a="1.2"===e?t.defaultValue:t["default"],i=i.concat(["1.2"===e?"defaultValue":"default"])),n.isUndefined(a))return;"array"===r?n.isUndefined(t.items)?I(a,r,t.format):I(a,"array"===r?t.items.type:r,"array"===r&&t.items.format?t.items.format:t.format):I(a,r,t.format),l(a,t["enum"]),u(a,t.maximum,r,t.exclusiveMaximum),m(a,t.maxItems),f(a,t.maxLength),c(a,t.maxProperties),p(a,t.minimum,r,t.exclusiveMinimum),h(a,t.minItems),v(a,t.minLength),x(a,t.minProperties),g(a,t.multipleOf),U(a,t.pattern),M(a,t.uniqueItems)}catch(s){throw s.path=i,s}}}}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{});
