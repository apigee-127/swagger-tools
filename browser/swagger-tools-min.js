...
(function(e){"use strict";var r="undefined"!=typeof window?window._:"undefined"!=typeof e?e._:null,n="undefined"!=typeof window?window.async:"undefined"!=typeof e?e.async:null,i=require("./helpers"),o="undefined"!=typeof window?window.JsonRefs:"undefined"!=typeof e?e.JsonRefs:null,t="undefined"!=typeof window?window.SparkMD5:"undefined"!=typeof e?e.SparkMD5:null,s=require("swagger-converter"),a="undefined"!=typeof window?window.traverse:"undefined"!=typeof e?e.traverse:null,c=require("./validators"),u={},d=function _(e,i,t){var s=r.reduce(o.findRefs(i),function(e,r,n){return o.isRemotePointer(n)&&e.push(r.split("#")[0]),e},[]),a=function(r,n){o.resolveRefs({$ref:r},function(r,i){return r?n(r):void _(e,i,function(e,r){n(e,r)})})};s.length>0?n.map(s,a,function(n,i){return n?t(n):(r.each(i,function(r,n){e.setRemoteReference(s[n],r)}),void t())}):t()},f=function(e,r,n,i){i.push({code:e,message:r,path:n})},p=function(e,n,t,s,a){var c,u,d,p,h,l=!0,g=i.getSwaggerVersion(e.resolved),m=r.isArray(n)?n:o.pathFromPointer(n),w=r.isArray(n)?o.pathToPointer(n):n,v=r.isArray(t)?t:o.pathFromPointer(t),E=r.isArray(t)?o.pathToPointer(t):t;return 0===m.length?(f("INVALID_REFERENCE","Not a valid JSON Reference",v,s.errors),!1):(u=e.definitions[w],h=m[0],c="securityDefinitions"===h?"SECURITY_DEFINITION":h.substring(0,h.length-1).toUpperCase(),d="1.2"===g?m[m.length-1]:w,p="securityDefinitions"===h?"Security definition":c.charAt(0)+c.substring(1).toLowerCase(),["authorizations","securityDefinitions"].indexOf(m[0])>-1&&"scopes"===m[2]&&(c+="_SCOPE",p+=" scope"),r.isUndefined(u)?(a||f("UNRESOLVABLE_"+c,p+" could not be resolved: "+d,v,s.errors),l=!1):(r.isUndefined(u.references)&&(u.references=[]),u.references.push(E)),l)},h=function C(e,n){var i,t,s="Composed "+("1.2"===e.swaggerVersion?o.pathFromPointer(n).pop():n),c=e.definitions[n],u=a(e.original),d=a(e.resolved);return c?(t=r.cloneDeep(u.get(o.pathFromPointer(n))),i=r.cloneDeep(d.get(o.pathFromPointer(n))),"1.2"===e.swaggerVersion&&(c.lineage.length>0&&(i.allOf=[],r.each(c.lineage,function(r){i.allOf.push(C(e,r))})),delete i.subTypes,r.each(i.properties,function(n,i){var s=t.properties[i];r.each(["maximum","minimum"],function(e){r.isString(n[e])&&(n[e]=parseFloat(n[e]))}),r.each(o.findRefs(s),function(r,i){var t="#/models/"+r,s=e.definitions[t],c=o.pathFromPointer(i);s.lineage.length>0?a(n).set(c.slice(0,c.length-1),C(e,t)):(a(n).set(c.slice(0,c.length-1).concat("title"),"Composed "+r),a(n).set(c.slice(0,c.length-1).concat("type"),"object"))})})),i=a(i).map(function(e){"id"===this.key&&r.isString(e)&&this.remove()}),i.title=s,i.type="object",i):void 0},l=function(e,r,n,i,o){f("UNUSED_"+r,n+" is defined but is not used: "+e,i,o)},g=function(e){var n=t.hash(JSON.stringify(e)),o=u[n]||r.find(u,function(e){return e.resolvedId===n});return o||(o=u[n]={definitions:{},original:e,resolved:void 0,swaggerVersion:i.getSwaggerVersion(e)}),o},m=function(e,r){var n=new Error("The Swagger document(s) are invalid");n.errors=e.errors,n.failedValidation=!0,n.warnings=e.warnings,e.apiDeclarations&&(n.apiDeclarations=e.apiDeclarations),r(n)},w=function(e){var n=e.match(/\{(.*?)\}/g),i=[],o=e;return n&&r.each(n,function(e,r){o=o.replace(e,"{"+r+"}"),i.push(e.replace(/[{}]/g,""))}),{path:o,args:i}},v=function(e,n,i,o,t,s){!r.isUndefined(e)&&e.indexOf(n)>-1&&f("DUPLICATE_"+i,o+" already defined: "+n,t,s)},E=function(e,r,n,i,o){try{c.validateSchemaConstraints(e.swaggerVersion,r,n,void 0)}catch(t){o||f(t.code,t.message,t.path,i.errors)}},b=function(e,n){var i=e.swaggerVersion,t=function(r){var n=o.pathToPointer(r),i=e.definitions[n];return i||(i=e.definitions[n]={references:[]},["definitions","models"].indexOf(o.pathFromPointer(n)[0])>-1&&(i.cyclical=!1,i.lineage=void 0,i.parents=[])),i},s=function(e){return"1.2"===i?o.pathFromPointer(e).pop():e},c=function h(n,i,o){var t=e.definitions[i||n];t&&r.each(t.parents,function(e){o.push(e),n!==e&&h(n,e,o)})},u="1.2"===i?"authorizations":"securityDefinitions",d="1.2"===i?"models":"definitions";switch(r.each(e.resolved[u],function(e,o){var s=[u,o];("1.2"!==i||e.type)&&(t(s),r.reduce(e.scopes,function(e,r,o){var a="1.2"===i?r.scope:o,c=s.concat(["scopes",o.toString()]),u=t(s.concat(["scopes",a]));return u.scopePath=c,v(e,a,"AUTHORIZATION_SCOPE_DEFINITION","Authorization scope definition","1.2"===i?c.concat("scope"):c,n.warnings),e.push(a),e},[]))}),r.each(e.resolved[d],function(s,a){var c=[d,a],u=t(c);if("1.2"===i&&a!==s.id&&f("MODEL_ID_MISMATCH","Model id does not match id in models object: "+s.id,c.concat("id"),n.errors),r.isUndefined(u.lineage))switch(i){case"1.2":r.each(s.subTypes,function(r,i){var s=["models",r],a=o.pathToPointer(s),u=e.definitions[a],f=c.concat(["subTypes",i.toString()]);!u&&e.resolved[d][r]&&(u=t(s)),p(e,s,f,n)&&u.parents.push(o.pathToPointer(c))});break;default:r.each(e.original[d][a].allOf,function(i,s){var a,d,f=c.concat(["allOf",s.toString()]);r.isUndefined(i.$ref)||o.isRemotePointer(i.$ref)?d=c.concat(["allOf",s.toString()]):(a=t(o.pathFromPointer(i.$ref)),d=o.pathFromPointer(i.$ref)),u.parents.push(o.pathToPointer(d)),a&&p(e,d,f,n)})}}),i){case"2.0":r.each(e.resolved.parameters,function(r,i){var o=["parameters",i];t(o),E(e,r,o,n)}),r.each(e.resolved.responses,function(r,i){var o=["responses",i];t(o),E(e,r,o,n)})}r.each(e.definitions,function(t,u){var d,p,h,l=o.pathFromPointer(u),g=a(e.original).get(l),m=l[0],w=m.substring(0,m.length-1).toUpperCase(),v=w.charAt(0)+w.substring(1).toLowerCase();-1!==["definitions","models"].indexOf(m)&&(d=[],p=[],h=t.lineage,r.isUndefined(h)&&(h=[],c(u,void 0,h),h.reverse(),t.lineage=r.cloneDeep(h),t.cyclical=h.length>1&&h[0]===u),t.parents.length>1&&"1.2"===i&&f("MULTIPLE_"+w+"_INHERITANCE","Child "+w.toLowerCase()+" is sub type of multiple models: "+r.map(t.parents,function(e){return s(e)}).join(" && "),l,n.errors),t.cyclical&&f("CYCLICAL_"+w+"_INHERITANCE",v+" has a circular inheritance: "+r.map(h,function(e){return s(e)}).join(" -> ")+" -> "+s(u),l.concat("1.2"===i?"subTypes":"allOf"),n.errors),r.each(h.slice(t.cyclical?1:0),function(n){var i=a(e.resolved).get(o.pathFromPointer(n));r.each(Object.keys(i.properties),function(e){-1===p.indexOf(e)&&p.push(e)})}),E(e,g,l,n),r.each(g.properties,function(i,o){var t=l.concat(["properties",o]);r.isUndefined(i)||(E(e,i,t,n),p.indexOf(o)>-1?f("CHILD_"+w+"_REDECLARES_PROPERTY","Child "+w.toLowerCase()+" declares property already declared by ancestor: "+o,t,n.errors):d.push(o))}),r.each(g.required||[],function(e,r){-1===p.indexOf(e)&&-1===d.indexOf(e)&&f("MISSING_REQUIRED_MODEL_PROPERTY","Model requires property but it is not defined: "+e,l.concat(["required",r.toString()]),n.errors)}))}),r.each(o.findRefs(e.original),function(r,i){"1.2"===e.swaggerVersion&&(r="#/models/"+r),o.isRemotePointer(r)||p(e,r,i,n)})},y=function(e,n,i,o,t,s){r.isUndefined(e)||-1!==e.indexOf(n)||f("UNRESOLVABLE_"+i,o+" could not be resolved: "+n,t,s)},j=function(e,n,i,o){var t="1.2"===e.swaggerVersion?"AUTHORIZATION":"SECURITY_DEFINITION",s="AUTHORIZATION"===t?"Authorization":"Security definition";"1.2"===e.swaggerVersion?r.reduce(n,function(n,a,c){var u="#/authorizations/"+c,d=i.concat([c]);return p(e,u,d,o)&&r.reduce(a,function(r,n,i){var a=d.concat(i.toString(),"scope"),c=u+"/scopes/"+n.scope;return v(r,n.scope,t+"_SCOPE_REFERENCE",s+" scope reference",a,o.warnings),p(e,c,a,o),r.concat(n.scope)},[]),n.concat(c)},[]):r.reduce(n,function(n,a,c){return r.each(a,function(a,u){var d="#/securityDefinitions/"+u,f=i.concat(c.toString(),u);v(n,u,t+"_REFERENCE",s+" reference",f,o.warnings),n.push(u),p(e,d,f,o)&&r.each(a,function(r,n){p(e,d+"/scopes/"+r,f.concat(n.toString()),o)})}),n},[])},O=function(e,n){var s,c=g(e),u=i.getSwaggerVersion(e);c.resolved?n():("1.2"===u&&(e=r.cloneDeep(e),s=a(e),r.each(o.findRefs(e),function(e,r){s.set(o.pathFromPointer(r),"#/models/"+e)})),o.resolveRefs(e,function(e,r){return e?n(e):(c.resolved=r,c.resolvedId=t.hash(JSON.stringify(r)),void n())}))},P=function(e,n,o,t){var s=r.isString(n)?e.validators[n]:i.createJsonValidator(),a=function(){try{c.validateAgainstSchema(n,o,s)}catch(e){return e.failedValidation?t(void 0,e.results):t(e)}O(o,function(e){return t(e)})};d(s,o,function(e){return e?t(e):void a()})},T=function(e,n){r.each(e.definitions,function(r,i){var t=o.pathFromPointer(i),s=t[0].substring(0,t[0].length-1),a="1.2"===e.swaggerVersion?t[t.length-1]:i,c="securityDefinition"===s?"SECURITY_DEFINITION":s.toUpperCase(),u="securityDefinition"===s?"Security definition":s.charAt(0).toUpperCase()+s.substring(1);0===r.references.length&&(r.scopePath&&(c+="_SCOPE",u+=" scope",t=r.scopePath),l(a,c,u,t,n.warnings))})},R=function(e,n,i,o,t,s,a){var c=[];r.reduce(o,function(e,o,a){var u=t.concat(["parameters",a.toString()]);if(!r.isUndefined(o))return v(e,o.name,"PARAMETER","Parameter",u.concat("name"),s.errors),("path"===o.paramType||"path"===o.in)&&(-1===i.args.indexOf(o.name)&&f("UNRESOLVABLE_API_PATH_PARAMETER","API path parameter could not be resolved: "+o.name,u.concat("name"),s.errors),c.push(o.name)),E(n,o,u,s,o.skipErrors),e.concat(o.name)},[]),(r.isUndefined(a)||a===!1)&&r.each(r.difference(i.args,c),function(e){f("MISSING_API_PATH_PARAMETER","API requires path parameter but it is not defined: "+e,"1.2"===n.swaggerVersion?t.slice(0,2).concat("path"):t,s.errors)})},S=function(e,n,i,o){var t=[],s=g(n),a=[],c={errors:[],warnings:[],apiDeclarations:[]};a=r.reduce(n.apis,function(e,r,n){return v(e,r.path,"RESOURCE_PATH","Resource path",["apis",n.toString(),"path"],c.errors),e.push(r.path),e},[]),b(s,c),t=r.reduce(i,function(n,i,o){var u=c.apiDeclarations[o]={errors:[],warnings:[]},d=g(i);return v(n,i.resourcePath,"RESOURCE_PATH","Resource path",["resourcePath"],u.errors),-1===t.indexOf(i.resourcePath)&&(y(a,i.resourcePath,"RESOURCE_PATH","Resource path",["resourcePath"],u.errors),n.push(i.resourcePath)),b(d,u),r.reduce(i.apis,function(n,i,o){var t=["apis",o.toString()],a=w(i.path);return n.indexOf(a.path)>-1?f("DUPLICATE_API_PATH","API path (or equivalent) already defined: "+i.path,t.concat("path"),u.errors):n.push(a.path),r.reduce(i.operations,function(n,i,o){var c=t.concat(["operations",o.toString()]);return v(n,i.method,"OPERATION_METHOD","Operation method",c.concat("method"),u.errors),n.push(i.method),-1===e.primitives.indexOf(i.type)&&"1.2"===e.version&&p(d,"#/models/"+i.type,c.concat("type"),u),j(s,i.authorizations,c.concat("authorizations"),u),E(d,i,c,u),R(e,d,a,i.parameters,c,u),r.reduce(i.responseMessages,function(e,r,n){var i=c.concat(["responseMessages",n.toString()]);return v(e,r.code,"RESPONSE_MESSAGE_CODE","Response message code",i.concat(["code"]),u.errors),r.responseModel&&p(d,"#/models/"+r.responseModel,i.concat("responseModel"),u),e.concat(r.code)},[]),n},[]),n},[]),T(d,u),n},[]),T(s,c),r.each(r.difference(a,t),function(e){var r=a.indexOf(e);l(n.apis[r].path,"RESOURCE_PATH","Resource path",["apis",r.toString(),"path"],c.errors)}),o(void 0,c)},U=function(e,n,i){var o=g(n),t={errors:[],warnings:[]};b(o,t),j(o,n.security,["security"],t),r.reduce(o.resolved.paths,function(n,i,s){var a=["paths",s],c=w(s);return n.indexOf(c.path)>-1&&f("DUPLICATE_API_PATH","API path (or equivalent) already defined: "+s,a,t.errors),R(e,o,c,i.parameters,a,t,!0),r.each(i,function(n,s){var u=[],d=a.concat(s),f=[];"parameters"!==s&&(j(o,n.security,d.concat("security"),t),r.each(n.parameters,function(e){u.push(e),f.push(e.name+":"+e.in)}),r.each(i.parameters,function(e){var n=r.cloneDeep(e);n.skipErrors=!0,-1===f.indexOf(e.name+":"+e.in)&&u.push(n)}),R(e,o,c,u,d,t),r.each(n.responses,function(e,r){E(o,e,d.concat("responses",r),t)}))}),n.concat(c.path)},[]),T(o,t),i(void 0,t)},A=function(e,r,n,o){var t=function(e,r){o(e,i.formatResults(r))};"1.2"===e.version?S(e,r,n,t):U(e,r,t)},D=function(e,i,o,t){P(e,"1.2"===e.version?"resourceListing.json":"schema.json",i,function(i,s){return i?t(i):void(s||"1.2"!==e.version?t(void 0,s):(s={errors:[],warnings:[],apiDeclarations:[]},n.map(o,function(r,n){P(e,"apiDeclaration.json",r,n)},function(e,n){return e?t(e):(r.each(n,function(e,r){s.apiDeclarations[r]=e}),void t(void 0,s))})))})},I=function(e){var n=function(e,n){return r.reduce(n,function(e,r,n){return e[n]=i.createJsonValidator(r),e}.bind(this),{})},o=function(e){var n=r.cloneDeep(this.schemas[e]);return n.id=e,n}.bind(this),t=["string","number","boolean","integer","array"];switch(e){case"1.2":this.docsUrl="https://github.com/swagger-api/swagger-spec/blob/master/versions/1.2.md",this.primitives=r.union(t,["void","File"]),this.schemasUrl="https://github.com/swagger-api/swagger-spec/tree/master/schemas/v1.2",this.schemas={"apiDeclaration.json":require("../schemas/1.2/apiDeclaration.json"),"authorizationObject.json":require("../schemas/1.2/authorizationObject.json"),"dataType.json":require("../schemas/1.2/dataType.json"),"dataTypeBase.json":require("../schemas/1.2/dataTypeBase.json"),"infoObject.json":require("../schemas/1.2/infoObject.json"),"modelsObject.json":require("../schemas/1.2/modelsObject.json"),"oauth2GrantType.json":require("../schemas/1.2/oauth2GrantType.json"),"operationObject.json":require("../schemas/1.2/operationObject.json"),"parameterObject.json":require("../schemas/1.2/parameterObject.json"),"resourceListing.json":require("../schemas/1.2/resourceListing.json"),"resourceObject.json":require("../schemas/1.2/resourceObject.json")},this.validators=n(this,{"apiDeclaration.json":r.map(["dataTypeBase.json","modelsObject.json","oauth2GrantType.json","authorizationObject.json","parameterObject.json","operationObject.json","apiDeclaration.json"],o),"resourceListing.json":r.map(["resourceObject.json","infoObject.json","oauth2GrantType.json","authorizationObject.json","resourceListing.json"],o)});break;case"2.0":this.docsUrl="https://github.com/swagger-api/swagger-spec/blob/master/versions/2.0.md",this.primitives=r.union(t,["file"]),this.schemasUrl="https://github.com/swagger-api/swagger-spec/tree/master/schemas/v2.0",this.schemas={"schema.json":require("../schemas/2.0/schema.json")},this.validators=n(this,{"schema.json":[o("schema.json")]});break;default:throw new Error(e+" is an unsupported Swagger specification version")}this.version=e};I.prototype.validate=function(e,n,o){switch(this.version){case"1.2":if(r.isUndefined(e))throw new Error("resourceListing is required");if(!r.isPlainObject(e))throw new TypeError("resourceListing must be an object");if(r.isUndefined(n))throw new Error("apiDeclarations is required");if(!r.isArray(n))throw new TypeError("apiDeclarations must be an array");break;case"2.0":if(r.isUndefined(e))throw new Error("swaggerObject is required");if(!r.isPlainObject(e))throw new TypeError("swaggerObject must be an object")}if("2.0"===this.version&&(o=arguments[1]),r.isUndefined(o))throw new Error("callback is required");if(!r.isFunction(o))throw new TypeError("callback must be a function");"2.0"===this.version&&(n=[]),D(this,e,n,function(r,t){r||i.formatResults(t)?o(r,t):A(this,e,n,o)}.bind(this))},I.prototype.composeModel=function(e,n,o){var t=i.getSwaggerVersion(e),s=function(r,t){var s;return r?o(r):i.getErrorCount(t)>0?m(t,o):(s=g(e),t={errors:[],warnings:[]},b(s,t),s.definitions[n]?i.getErrorCount(t)>0?m(t,o):void o(void 0,h(s,n)):o())};switch(this.version){case"1.2":if(r.isUndefined(e))throw new Error("apiDeclaration is required");if(!r.isPlainObject(e))throw new TypeError("apiDeclaration must be an object");if(r.isUndefined(n))throw new Error("modelId is required");break;case"2.0":if(r.isUndefined(e))throw new Error("swaggerObject is required");if(!r.isPlainObject(e))throw new TypeError("swaggerObject must be an object");if(r.isUndefined(n))throw new Error("modelRef is required")}if(r.isUndefined(o))throw new Error("callback is required");if(!r.isFunction(o))throw new TypeError("callback must be a function");if("#"!==n.charAt(0)){if("1.2"!==this.version)throw new Error("modelRef must be a JSON Pointer");n="#/models/"+n}P(this,"1.2"===t?"apiDeclaration.json":"schema.json",e,s)},I.prototype.validateModel=function(e,n,i,o){switch(this.version){case"1.2":if(r.isUndefined(e))throw new Error("apiDeclaration is required");if(!r.isPlainObject(e))throw new TypeError("apiDeclaration must be an object");if(r.isUndefined(n))throw new Error("modelId is required");break;case"2.0":if(r.isUndefined(e))throw new Error("swaggerObject is required");if(!r.isPlainObject(e))throw new TypeError("swaggerObject must be an object");if(r.isUndefined(n))throw new Error("modelRef is required")}if(r.isUndefined(i))throw new Error("data is required");if(r.isUndefined(o))throw new Error("callback is required");if(!r.isFunction(o))throw new TypeError("callback must be a function");this.composeModel(e,n,function(e,r){return e?o(e):void P(this,r,i,o)}.bind(this))},I.prototype.resolve=function(e,n,t){var s,c,u=function(e){return r.isString(n)?t(void 0,a(e).get(o.pathFromPointer(n))):t(void 0,e)};if(r.isUndefined(e))throw new Error("document is required");if(!r.isPlainObject(e))throw new TypeError("document must be an object");if(2===arguments.length&&(t=arguments[1],n=void 0),!r.isUndefined(n)&&!r.isString(n))throw new TypeError("ptr must be a JSON Pointer string");if(r.isUndefined(t))throw new Error("callback is required");if(!r.isFunction(t))throw new TypeError("callback must be a function");if(s=g(e),"1.2"===s.swaggerVersion)throw new Error("Swagger 1.2 is not supported");return s.resolved?u(s.resolved):(c="1.2"===s.swaggerVersion?r.find(["basePath","consumes","models","produces","resourcePath"],function(n){return!r.isUndefined(e[n])})?"apiDeclaration.json":"resourceListing.json":"schema.json",void P(this,c,e,function(e,r){return e?t(e):i.getErrorCount(r)>0?m(r,t):u(s.resolved)}))},I.prototype.convert=function(e,n,o,t){var a=function(e,r){t(void 0,s(e,r))}.bind(this);if("1.2"!==this.version)throw new Error("Specification#convert only works for Swagger 1.2");if(r.isUndefined(e))throw new Error("resourceListing is required");if(!r.isPlainObject(e))throw new TypeError("resourceListing must be an object");if(r.isUndefined(n))throw new Error("apiDeclarations is required");if(!r.isArray(n))throw new TypeError("apiDeclarations must be an array");if(arguments.length<4&&(t=arguments[arguments.length-1]),r.isUndefined(t))throw new Error("callback is required");if(!r.isFunction(t))throw new TypeError("callback must be a function");o===!0?a(e,n):this.validate(e,n,function(r,o){return r?t(r):i.getErrorCount(o)>0?m(o,t):void a(e,n)})},module.exports.v1=module.exports.v1_2=new I("1.2"),module.exports.v2=module.exports.v2_0=new I("2.0")}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{});
