...
(function(e){"use strict";var r="undefined"!=typeof window?window._:"undefined"!=typeof e?e._:null,n="undefined"!=typeof window?window.jjv:"undefined"!=typeof e?e.jjv:null,t=require("jjve"),s="undefined"!=typeof window?window.SparkMD5:"undefined"!=typeof e?e.SparkMD5:null,a="undefined"!=typeof window?window.traverse:"undefined"!=typeof e?e.traverse:null,i=require("./helpers"),o=require("./validators"),c=require("../schemas/json-schema-draft-04.json"),d="http://json-schema.org/draft-04/schema",u={checkRequired:!0,removeAdditional:!1,useDefault:!1,useCoerce:!1},h={formatPath:!1},m={},p=i.refToJsonPointer,f=i.toJsonPointer,l=function(e,s){var a=n(u);return a.addFormat("uri",function(){return!0}),a.addSchema(d,c),r.each(s,function(n){var t=r.cloneDeep(e.schemas[n]);t.id=n,a.addSchema(n,t)}.bind(this)),a.je=t(a),a},v=function(e,r,n,t,s){s.push({code:e,message:r,data:n,path:t})},g=function(e,r,n,t,s,a){v("UNUSED_"+n,t+" is defined but is not used: "+r,e,s,a)},O=function(e,n,t,s,a,i){r.isUndefined(e)||-1!==e.indexOf(n)||v("UNRESOLVABLE_"+t,s+" could not be resolved: "+n,n,a,i)},y=function(e,n,t,s,a,i){!r.isUndefined(e)&&e.indexOf(n)>-1&&v("DUPLICATE_"+t,s+" already defined: "+n,n,a,i)},A=function(e,n,t,s,a){var i=s[s.length-1];r.isUndefined(e)||e.length===r.uniq(e).length||v("DUPLICATE_"+n,t+" "+i+" has duplicate items",e,s,a)},E=function(e,r,n,t,s){switch(e.version){case"1.2":try{o.validateTypeAndFormat(r.name,n,"array"===r.type?r.items.type:r.type,"array"===r.type&&r.items.format?r.items.format:r.format)}catch(a){return void v("INVALID_TYPE",a.message,n,t,s)}try{o.validateEnum(r.name,n,r.enum)}catch(a){return void v("ENUM_MISMATCH",a.message,n,t,s)}try{o.validateMaximum(r.name,n,r.maximum,r.type)}catch(a){return void v("MAXIMUM",a.message,n,t,s)}try{o.validateMinimum(r.name,n,r.minimum,r.type)}catch(a){return void v("MINIMUM",a.message,n,t,s)}try{o.validateUniqueItems(r.name,n,r.uniqueItems)}catch(a){return void v("ARRAY_UNIQUE",a.message,n,t,s)}break;case"2.0":try{o.validateTypeAndFormat(r.name,n,"array"===r.type?r.items.type:r.type,"array"===r.type&&r.items.format?r.items.format:r.format)}catch(a){return void v("INVALID_TYPE",a.message,n,t,s)}try{o.validateEnum(r.name,n,r.enum)}catch(a){return void v("ENUM_MISMATCH",a.message,n,t,s)}try{o.validateMaximum(r.name,n,r.maximum,r.type,r.exclusiveMaximum)}catch(a){return void v(r.exclusiveMaximum===!0?"MAXIMUM_EXCLUSIVE":"MAXIMUM",a.message,n,t,s)}try{o.validateMaxItems(r.name,n,r.maxItems)}catch(a){return void v("ARRAY_LENGTH_LONG",a.message,n,t,s)}try{o.validateMaxLength(r.name,n,r.maxLength)}catch(a){return void v("MAX_LENGTH",a.message,n,t,s)}try{o.validateMinimum(r.name,n,r.minimum,r.type,r.exclusiveMinimum)}catch(a){return void v("true"===r.exclusiveMinimum?"MINIMUM_EXCLUSIVE":"MINIMUM",a.message,n,t,s)}try{o.validateMinItems(r.name,n,r.minItems)}catch(a){return void v("ARRAY_LENGTH_SHORT",a.message,n,t,s)}try{o.validateMinLength(r.name,n,r.minLength)}catch(a){return void v("MIN_LENGTH",a.message,n,t,s)}try{o.validatePattern(r.name,n,r.pattern)}catch(a){return void v("PATTERN",a.message,n,t,s)}try{o.validateUniqueItems(r.name,n,r.uniqueItems)}catch(a){return void v("ARRAY_UNIQUE",a.message,n,t,s)}}},j=function(e){var n=[],t=[];return r.each(e.split("/"),function(e){"{"===e.charAt(0)&&(n.push(e.substring(1).split("}")[0]),e="{"+(n.length-1)+"}"),t.push(e)}),{path:t.join("/"),args:n}},w=function(e){var n,t,s=["string","number","boolean","integer","array"];switch(e){case"1.2":n="https://github.com/wordnik/swagger-spec/blob/master/versions/1.2.md",s=r.union(s,["void","File"]),t="https://github.com/wordnik/swagger-spec/tree/master/schemas/v1.2";break;case"2.0":n="https://github.com/wordnik/swagger-spec/blob/master/versions/2.0.md",s=r.union(s,["file"]),t="https://github.com/wordnik/swagger-spec/tree/master/schemas/v2.0";break;default:throw new Error(e+" is an unsupported Swagger specification version")}switch(this.docsUrl=n,this.primitives=s,this.schemasUrl=t,this.version=e,this.schemas={},this.validators={},e){case"1.2":this.schemas["apiDeclaration.json"]=require("../schemas/1.2/apiDeclaration.json"),this.schemas["authorizationObject.json"]=require("../schemas/1.2/authorizationObject.json"),this.schemas["dataType.json"]=require("../schemas/1.2/dataType.json"),this.schemas["dataTypeBase.json"]=require("../schemas/1.2/dataTypeBase.json"),this.schemas["infoObject.json"]=require("../schemas/1.2/infoObject.json"),this.schemas["modelsObject.json"]=require("../schemas/1.2/modelsObject.json"),this.schemas["oauth2GrantType.json"]=require("../schemas/1.2/oauth2GrantType.json"),this.schemas["operationObject.json"]=require("../schemas/1.2/operationObject.json"),this.schemas["parameterObject.json"]=require("../schemas/1.2/parameterObject.json"),this.schemas["resourceListing.json"]=require("../schemas/1.2/resourceListing.json"),this.schemas["resourceObject.json"]=require("../schemas/1.2/resourceObject.json"),this.validators["apiDeclaration.json"]=l(this,["dataTypeBase.json","modelsObject.json","oauth2GrantType.json","authorizationObject.json","parameterObject.json","operationObject.json","apiDeclaration.json"]),this.validators["resourceListing.json"]=l(this,["resourceObject.json","infoObject.json","oauth2GrantType.json","authorizationObject.json","resourceListing.json"]);break;case"2.0":this.schemas["schema.json"]=require("../schemas/2.0/schema.json"),this.validators["schema.json"]=l(this,["schema.json"])}},b=function(e,n){var t=e[n];return r.isUndefined(t)&&(t=e[n]={composed:{},name:void 0,parents:[],refs:[],schema:void 0}),t},U=function P(e,n,t,s,a,i){var o=b(n,s),c=function(e){return 0===e.indexOf("http://")||0===e.indexOf("https://")};switch(o.schema=t,o.name=s,o.path=a,e.version){case"1.2":o.name=a[a.length-1],r.each(t.properties,function(t,s){var o=a.concat("properties",s);t.$ref?b(n,t.$ref).refs.push(o.concat(["$ref"])):"array"===t.type&&t.items.$ref&&b(n,t.items.$ref).refs.push(o.concat(["items","$ref"])),r.isUndefined(t.defaultValue)||E(e,t,t.defaultValue,o.concat("defaultValue"),i.errors)}),r.each(r.uniq(t.subTypes),function(e,r){var t=b(n,e);t.parents.push(s),t.refs.push(a.concat("subTypes",r.toString()))});break;case"2.0":r.each(r.uniq(t.allOf),function(t,s){var d=a.concat("allOf",s.toString());r.isUndefined(t.$ref)?(P(e,n,t,f(d),d,i),o.parents.push(f(d))):c(t.$ref)||(o.parents.push(p(t.$ref)),b(n,p(t.$ref)).refs.push(d.concat("$ref")))}),r.isUndefined(t.default)||E(e,t,t.defaultValue,a.concat("default"),i.errors),t.$ref?c(t.$ref)||b(n,p(t.$ref)).refs.push(a.concat(["$ref"])):"array"===t.type&&(t.items.$ref?c(t.items.$ref)||b(n,p(t.items.$ref)).refs.push(a.concat(["items","$ref"])):r.isUndefined(t.items.type)||-1!==e.primitives.indexOf(t.items.type)||r.each(t.items,function(r,t){var s=a.concat("items",t.toString());P(e,n,r,f(s),s,i)})),r.each(t.properties,function(t,s){var o=a.concat("properties",s);t.$ref?c(t.$ref)||b(n,p(t.$ref)).refs.push(o.concat(["$ref"])):"array"===t.type&&(t.items.$ref?c(t.items.$ref)||b(n,p(t.items.$ref)).refs.push(o.concat(["items","$ref"])):r.isUndefined(t.items.type)||-1!==e.primitives.indexOf(t.items.type)||r.each(t.items,function(r,t){var s=o.concat("items",t.toString());P(e,n,r,f(s),s,i)}))}),-1===f(a).indexOf("#/definitions/")&&o.refs.push(a)}},I=function(e,n,t){var i,o={},c={errors:[],warnings:[]},d={},u={},h=function(n,t){var s=i[n].schema;s&&(r.each(s.properties,function(s,a){var i=r.cloneDeep(s);t.properties[a]?v("CHILD_MODEL_REDECLARES_PROPERTY","Child model declares property already declared by ancestor: "+a,s,"1.2"===e.version?["models",n,"properties",a]:n.substring(2).split("/").concat("properties",a),c.errors):("1.2"===e.version&&(r.isUndefined(i.maximum)||(i.maximum=parseFloat(i.maximum)),r.isUndefined(i.minimum)||(i.minimum=parseFloat(i.minimum))),t.properties[a]=i)}),!r.isUndefined(s.required)&&r.isUndefined(t.required)&&(t.required=[]),r.each(s.required,function(e){-1===t.required.indexOf(e)&&t.required.push(e)}))},l=function(e,r){var n=!1;return Object.keys(r).filter(function(t){return t===e&&(n=!0),n&&r[t]})},g=function E(n,t,s,a,o){var d=i[n],u=d.schema;a[n]=!0,r.isUndefined(u)||(d.parents.length>1&&"1.2"===e.version?v("MULTIPLE_MODEL_INHERITANCE","Child model is sub type of multiple models: "+d.parents.join(" && "),u,["models",n],c.errors):r.each(d.parents,function(r){s[r]||(a[r]&&(t[n]=l(r,a),v("CYCLICAL_MODEL_INHERITANCE","Model has a circular inheritance: "+n+" -> "+t[n].join(" -> "),"1.2"===e.version?u.subTypes:u.allOf,"1.2"===e.version?["models",n,"subTypes"]:n.substring(2).split("/").concat("allOf"),c.errors)),t[n]||E(r,t,s,a,o)),t[n]||h(r,o)})),s[n]=!0,a[n]=!1},O=s.hash(JSON.stringify(n)),A=m[O];if(r.isUndefined(A)){switch(A=m[O]={metadata:{},results:c},i=A.metadata,e.version){case"1.2":r.reduce(n.models,function(r,n,t){return y(r,n.id,"MODEL_DEFINITION","Model",["models",t,"id"],c.errors),U(e,i,n,n.id,["models",t],c),r.concat(n.id)},[]);break;case"2.0":r.each(n.definitions,function(r,n){var t=["definitions",n];U(e,i,r,f(t),t,c)})}r.each(i,function(e,n){e.composed={title:"Composed "+n,type:"object",properties:{}},r.isUndefined(e.schema)||(g(n,o,d,u,e.composed),h(n,e.composed)),r.isUndefined(e.schema)||r.isUndefined(e.schema.required)||r.each(e.schema.required,function(n,s){r.isUndefined(e.composed.properties[n])&&v("MISSING_REQUIRED_MODEL_PROPERTY","Model requires property but it is not defined: "+n,n,e.path.concat(["required",s.toString()]),t.errors)})}),r.each(i,function(n){var t=a(n.composed).reduce(function(r){return"$ref"===this.key&&(r[f(this.path)]="1.2"===e.version?this.node:p(this.node)),r},{});r.each(t,function(e,t){var s=t.substring(2).split("/"),o=r.isUndefined(i[e])?void 0:r.cloneDeep(i[e].composed);r.isUndefined(o)||(delete o.id,delete o.title,a(n.composed).set(s.slice(0,s.length-1),o))})}),r.isUndefined(t)||r.each(c,function(e,r){t[r]=t[r].concat(e)})}return A},T=function(e,r,n){var t=e.validators[r],s=t.schema[r],a=t.validate(s,n),i={errors:[],warnings:[]};return a&&(i={errors:t.je(s,n,a,h),warnings:[]}),i},M=function(e,n,t){var s={errors:[],warnings:[]},a={},i={},o=[],c=[];switch(e.version){case"1.2":r.each(n.apis,function(e,r){y(o,e.path,"RESOURCE_PATH","Resource path",["apis",r.toString(),"path"],s.errors),-1===o.indexOf(e.path)&&o.push(e.path)}),0===s.errors.length&&(r.each(n.authorizations,function(e,n){a[n]=r.map(e.scopes,function(e){return e.scope})},{}),s.apiDeclarations=[],r.each(t,function(n,t){var d=s.apiDeclarations[t]={errors:[],warnings:[]},u={},h={},m=I(e,n,d).metadata,p=function(e,r){var n=b(m,e);n.refs.push(r)},f=function(e,n){var t;r.isUndefined(u[e])?(t=i[e],r.isUndefined(t)&&(t=i[e]=[])):(t=h[e],r.isUndefined(t)&&(t=h[e]=[])),-1===t.indexOf(n)&&t.push(n)};r.each(n.authorizations,function(e,n){u[n]=r.map(e.scopes,function(e){return e.scope})},{}),y(c,n.resourcePath,"RESOURCE_PATH","Resource path",["resourcePath"],d.errors),O(o,n.resourcePath,"RESOURCE_PATH","Resource path",["resourcePath"],d.errors),-1===c.indexOf(n.resourcePath)&&c.push(n.resourcePath),r.each(["consumes","produces"],function(e){A(n[e],"API_"+e.toUpperCase(),"API",[e],d.warnings)}),r.reduce(n.apis,function(n,t,s){var i=["apis",s.toString()],o=j(t.path),c=[];return n.indexOf(o.path)>-1&&v("DUPLICATE_API_PATH","API path (or equivalent) already defined: "+t.path,t.path,i.concat("path"),d.errors),r.reduce(t.operations,function(n,s,h){var m=i.concat(["operations",h.toString()]);return r.each(["consumes","produces"],function(e){A(s[e],"OPERATION_"+e.toUpperCase(),"Operation",m.concat(e),d.warnings)}),y(n,s.method,"OPERATION_METHOD","Operation method",m.concat("method"),d.errors),r.each(s.authorizations,function(e,n){O(r.uniq(Object.keys(u).concat(Object.keys(a))),n,"AUTHORIZATION","Authorization",m.concat(["authorizations",n]),d.errors),r.each(e,function(e,t){r.isUndefined(u[n])&&r.isUndefined(a[n])||O(r.uniq((u[n]||[]).concat(a[n]||[])),e.scope,"AUTHORIZATION_SCOPE","Authorization scope",m.concat(["authorizations",n,t.toString(),"scope"]),d.errors),f(n,e.scope)})}),r.reduce(s.parameters,function(n,t,s){return-1===e.primitives.indexOf(t.type)?p(t.type,m.concat(["parameters",s.toString(),"type"])):"array"===t.type&&t.items.$ref&&p(t.items.$ref,m.concat(["parameters",s.toString(),"items","$ref"])),y(n,t.name,"OPERATION_PARAMETER","Operation parameter",m.concat("parameters",s.toString(),"name"),d.errors),"path"===t.paramType&&(-1===o.args.indexOf(t.name)&&v("UNRESOLVABLE_API_PATH_PARAMETER","API path parameter could not be resolved: "+t.name,t.name,m.concat("parameters",s.toString(),"name"),d.errors),-1===c.indexOf(t.name)&&c.push(t.name)),r.isUndefined(t.defaultValue)||E(e,t,t.defaultValue,m.concat("parameters",s.toString(),"defaultValue"),d.errors),n.concat(t.name)},[]),r.each(r.difference(o.args,c),function(e){v("MISSING_API_PATH_PARAMETER","API requires path parameter but it is not defined: "+e,t.path,i.concat("path"),d.errors)}),r.reduce(s.responseMessages,function(e,r,n){return y(e,r.code,"RESPONSE_MESSAGE_CODE","Response message code",m.concat(["responseMessages",n.toString(),"code"]),d.errors),r.responseModel&&p(r.responseModel,m.concat(["responseMessages",n.toString(),"responseModel"])),e.concat(r.code)},[]),"array"===s.type&&s.items.$ref?p(s.items.$ref,m.concat(["items","$ref"])):-1===e.primitives.indexOf(s.type)&&p(s.type,m.concat(["type"])),n.concat(s.method)},[]),n.concat(o.path)},[]),r.each(m,function(e,n){r.isUndefined(e.schema)&&r.each(e.refs,function(e){v("UNRESOLVABLE_MODEL","Model could not be resolved: "+n,n,e,d.errors)}),0===e.refs.length&&g(e.schema,n,"MODEL","Model",["models",e.name],d.warnings)}),r.each(r.difference(Object.keys(u),Object.keys(h)),function(e){g(n.authorizations[e],e,"AUTHORIZATION","Authorization",["authorizations",e],d.warnings)}),r.each(u,function(e,t){var s=["authorizations",t],a=n.authorizations[t];r.each(r.difference(e,h[t]||[]),function(r){var n=e.indexOf(r);g(a.scopes[n],r,"AUTHORIZATION_SCOPE","Authorization scope",s.concat(["scopes",n.toString()]),d.warnings)})})}),r.each(r.difference(o,c),function(e){var t=r.map(n.apis,function(e){return e.path}).indexOf(e);g(n.apis[t].path,e,"RESOURCE_PATH","Resource path",["apis",t.toString(),"path"],s.errors)}),r.each(r.difference(Object.keys(a),Object.keys(i)),function(e){g(n.authorizations[e],e,"AUTHORIZATION","Authorization",["authorizations",e],s.warnings)}),r.each(i,function(e,t){var a=["authorizations",t];r.each(r.difference(e,i[t]),function(r){var i=e.indexOf(r);g(n.authorizations[t].scopes[i],r,"AUTHORIZATION_SCOPE","Authorization scope",a.concat(["scopes",i.toString()]),s.warnings)})}));break;case"2.0":if(r.each(["consumes","produces","schemes"],function(e){A(n[e],"API_"+e.toUpperCase(),"API",[e],s.warnings)}),0===s.errors.length&&0===s.warnings.length){var d=I(e,n,s).metadata;r.reduce(n.paths,function(n,t,a){var i=["paths",a],o=j(a),c=[];return n.indexOf(o.path)>-1&&v("DUPLICATE_API_PATH","API path (or equivalent) already defined: "+a,a,i,s.errors),r.each(t,function(n,a){var u=i.concat(a);return"parameters"===a?void r.reduce(t.parameters,function(n,t,a){var i=u.concat(a.toString());return y(n,t.name,"API_PARAMETER","API parameter",i.concat("name"),s.errors),"path"===t.in&&(-1===o.args.indexOf(t.name)&&v("UNRESOLVABLE_API_PATH_PARAMETER","API path parameter could not be resolved: "+t.name,t.name,i.concat("name"),s.errors),-1===c.indexOf(t.name)&&c.push(t.name)),r.isUndefined(t.schema)||U(e,d,t.schema,f(i.concat("schema")),i.concat("schema"),s),n.concat(t.name)},[]):(r.each(["consumes","produces","schemes"],function(e){A(n[e],"OPERATION_"+e.toUpperCase(),"Operation",u.concat(e),s.warnings)}),r.reduce(n.parameters,function(n,t,a){var i=u.concat("parameters",a.toString());return y(n,t.name,"OPERATION_PARAMETER","Operation parameter",i.concat("name"),s.errors),"path"===t.in&&(-1===o.args.indexOf(t.name)&&v("UNRESOLVABLE_API_PATH_PARAMETER","API path parameter could not be resolved: "+t.name,t.name,i.concat("name"),s.errors),-1===c.indexOf(t.name)&&c.push(t.name)),r.isUndefined(t.schema)||U(e,d,t.schema,f(i.concat("schema")),i.concat("schema"),s),n.concat(t.name)},[]),void r.each(n.responses,function(n,t){var s=u.concat("responses",t);r.isUndefined(n.schema)||U(e,d,n.schema,f(s.concat("schema")),s.concat("schema"),n)}))}),r.each(r.difference(o.args,c),function(e){v("MISSING_API_PATH_PARAMETER","API requires path parameter but it is not defined: "+e,a,i,s.errors)}),n.concat(o.path)},[]),r.each(d,function(e,n){r.isUndefined(e.schema)&&r.each(e.refs,function(e){v("UNRESOLVABLE_MODEL","Model could not be resolved: "+n,n,e,s.errors)}),0===e.refs.length&&g(e.schema,n,"MODEL","Model",n.substring(2).split("/"),s.warnings)})}}return s};w.prototype.validate=function(e,n){var t={errors:[],warnings:[]},s=!1;switch(this.version){case"1.2":if(r.isUndefined(e))throw new Error("resourceListing is required");if(!r.isPlainObject(e))throw new TypeError("resourceListing must be an object");if(r.isUndefined(n))throw new Error("apiDeclarations is required");if(!r.isArray(n))throw new TypeError("apiDeclarations must be an array");t=T(this,"resourceListing.json",e),t.errors.length>0&&(s=!0),s||(t.apiDeclarations=[],r.each(n,function(e,r){return t.apiDeclarations[r]=T(this,"apiDeclaration.json",e),t.apiDeclarations[r].errors.length>0?(s=!0,!1):void 0}.bind(this))),s||(t=M(this,e,n)),t=t.errors.length>0||t.warnings.length>0||r.reduce(t.apiDeclarations,function(e,n){return e+(r.isArray(n.errors)?n.errors.length:0)+(r.isArray(n.warnings)?n.warnings.length:0)},0)>0?t:void 0;break;case"2.0":if(r.isUndefined(e))throw new Error("swaggerObject is required");if(!r.isPlainObject(e))throw new TypeError("swaggerObject must be an object");t=T(this,"schema.json",e),t.errors.length>0&&(s=!0),s||(t=M(this,e)),t=t.errors.length>0||t.warnings.length>0?t:void 0}return t},w.prototype.composeModel=function(e,n){var t,s,a,i;switch(this.version){case"1.2":if(r.isUndefined(e))throw new Error("apiDeclaration is required");if(!r.isPlainObject(e))throw new TypeError("apiDeclaration must be an object");if(r.isUndefined(n))throw new Error("modelId is required");break;case"2.0":if(r.isUndefined(e))throw new Error("swaggerObject is required");if(!r.isPlainObject(e))throw new TypeError("swaggerObject must be an object");if(r.isUndefined(n))throw new Error("modelIdOrPath is required")}if(t=I(this,e),a=t.metadata,t.results.errors.length>0)throw i=new Error("The models are invalid and model composition is not possible"),i.errors=t.results.errors,i.warnings=t.results.warnings,i;return s=a["1.2"===this.version?n:p(n)],r.isUndefined(s)?void 0:s.composed},w.prototype.validateModel=function(e,s,a){var i,o,m=this.composeModel(e,s);if(r.isUndefined(m))throw Error("Unable to compose model so validation is not possible");return o=n(u),o.addFormat("uri",function(){return!0}),o.addSchema(d,c),o.je=t(o),i=o.validate(m,a),i=i?{errors:o.je(m,a,i,h)}:void 0},module.exports.v1=module.exports.v1_2=new w("1.2"),module.exports.v2=module.exports.v2_0=new w("2.0")}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{});
